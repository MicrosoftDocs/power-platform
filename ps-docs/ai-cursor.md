...
> - **Add data**: You can add additional data to an existing workspace using the AI cursor. You can add more data by [uploading files](ask-question.md#supported-data-files) or [connecting to a data source](ask-question.md#connecting-to-salesforce-and-dynamics-365) such as Dynamics 365 and Salesforce.
