...
You can set a _context_ for Project "Sophia" to provide Project "Sophia" with a specific perspective from which to interpret data to increase the relevancy and consistency of the reports Project "Sophia" generates. Project "Sophia" applies your context to how it interprets all prompts you enter while the context is active, so you don't need to repeat that contextual information every time you generate a report.
