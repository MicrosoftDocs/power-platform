...
4. **Suggested next steps**: Designed to inspire deeper explorations or actions based on the information currently available on the canvas. When you interact with the system either by asking questions or uploading a file, the suggested next step block suggests up to five actions that you can try to expand your analysis. You aren't limited to the suggested next steps generated as you can use AI Cursor to write your own next step. 
