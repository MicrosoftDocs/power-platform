...
| [**Secure intelligent document processing with Azure Virtual Network support**](../reference-architectures/secure-document-automation.md) | Securely automate document ingestion, processing, validation, and storage by using Power Automate, Azure Document Intelligence, and private network connectivity. |
