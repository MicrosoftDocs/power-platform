...
ms.date: 01/20/2025
ms.author: v-caclaesson@microsoft.com
ms.reviewer: jhaskett-msft
---  

# ​​Build Agents with Copilot Studio for Onboarding​

Use Copilot Studio and Power Platform to create an AI-driven Onboarding agent that automates onboarding process by integrating multiple systems, creating custom learning recommendations and answering candidate questions. Manual and fragmented onboarding processes lead to inefficiencies, delays, and inconsistent new-hire experiences. Using the custom agent approach integrates multiple sources to provide a seamless experience for new hires and HR teams.
...
- [Knowledge sources overview - Microsoft Copilot Studio | Microsoft Learn ](/microsoft-copilot-studio/knowledge-copilot-studio)
- [Multi-agent orchestration and more: Copilot Studio announcements | Microsoft Copilot Blog](https://www.microsoft.com/microsoft-copilot/blog/copilot-studio/multi-agent-orchestration-maker-controls-and-more-microsoft-copilot-studio-announcements-at-microsoft-build-2025)
