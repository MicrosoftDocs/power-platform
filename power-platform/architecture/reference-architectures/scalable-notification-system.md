---
title: Implement a scalable notification system with Power Platform
description: Learn to scale business applications with Microsoft Power Platform. Implement a scalable notification system to automate SMS and email reminders.
...
Microsoft Power Platform provides a way to scale business applications while integrating with enterprise-grade cloud services for high-volume operations. The scalable notification system uses this capability to send SMS and email reminders for appointments stored in Microsoft Dataverse. Key features include:
