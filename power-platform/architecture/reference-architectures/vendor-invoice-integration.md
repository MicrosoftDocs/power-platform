...
description: Learn how to automate vendor invoice ingestion by extracting and validating XML invoice data into Dynamics 365 using Power Automate and AI Builder.
...
1. **Data Transformation**: The workflow maps extracted XML fields to the Dynamics 365 entity schema, converts dates to ISO 8601 format, converts amounts to decimal, and prepares line items as arrays.

1. **Dynamics 365 Integration**: The workflow creates the validated invoice data as a pending vendor invoice record in Dynamics 365 Finance & Operations by using either the Dataverse connector or Dynamics 365 connector.
...
- Creates a unified audit log (SharePoint or Dataverse) and attaches original XML and PDF to the ERP document for long‑term retention.
