...
:::image type="content" source="media/agent-donor-management/architecture.png" alt-text="Architecture diagram of an AI-enabled donor management solution." border="true" lightbox="media/agent-donor-management/architecture.png":::
...
- [**Power Apps**](/power-apps/) (Model-Driven):  Delivers donor management UI. Selected for process-heavy, relational data scenarios over canvas apps.

- [**Power Pages**](/power-pages/): B2C platform enabling Online Donation transactions, and inquiries support.

- [**SharePoint**](/sharepoint/) & [**OneDrive**](/onedrive/): Store donor documents. Chosen for collaboration and Power Automate triggers over Azure Blob Storage.

- [**Teams**](/microsoft-teams/group-chat-software/) & [**Approvals**](https://support.microsoft.com/office/what-is-approvals-a9a01c95-e0bf-4d20-9ada-f7be3fc283d3): Enable collaboration and decision-making. Selected for native integration over custom adaptive cards.
