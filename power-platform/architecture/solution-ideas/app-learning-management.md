---
title: Learning management app leveraging Microsoft Learn content
...
# Learning management app leveraging Microsoft Learn content

In this article, you will learn about a training system that uses integrations with Microsoft Learn and various Microsoft Power Platform services to improve trainer and learner experiences.
...
This solution uses a wide range of Power Platform resources to ensure up-to-date content is presented and proper assignment has taken place.

1. **Content Integrations**
    1. Power Automate flows will listen to any modified learning paths or modules to ensure the relationship between them are consistent.

    1. From training assignment to learner submission, Power Automate will create notifications for both personas to ensure lifecycle of training is communicated.
...
1. **Model-driven app (Trainers)**
    1. Trainers will access a Model-driven app to create custom training plans based on the ingested Microsoft Learn Content.

    1. Dashboards will provide visibility to Trainers for submitted trainings from Learners for review and finalization.
...
1. **Learner Portal (Learners)**
    1. Employees will access the Learner Power Page and authenticate using Microsoft Entra ID SSO authentication.

    1. Learners will be able to view their training assignment, where they can view content and length of training to help plan their self-paced training. They will be redirected to Microsoft Learn to complete trainings. Once learning path or module has been complete, they will update their assigned training of completion.

    1. Optionally, Learners can browse, filter based on Role and self-assign trainings they are interested in through the Learning Catalog.

## Scenario details

This use case is based on a company that wanted to improve its visibility into employee training and reduce the time required to create training plans.
...
- This design applies to the reducing of content management overhead by leveraging a ready-made API provided by Microsoft. Ensures resilient and consistent ingestion of Microsoft Learn catalog updates.
