...
description: Learn how to use the Appointment Booking app for Microsoft Power Platform to streamline and automate the management of your appointments.
...
- **Meeting Provider**: As a Meeting Provider, you use the app to set up and manage your appointment slots and handle related bookings. Delegates can also be assigned to Meeting Providers to oversee the appointment booking process.
...
1. On the Add Appointment Slot screen, make selections from the dropdown menu for:
...
> [!NOTE]
> If you select **In Person** from the *Meeting Via* dropdown menu, you also need to specify values for Location (building) and Room Number fields.
...
1. Select **Submit**. This triggers the *Rescheduled Outlook Invite flow* that reschedules the Outlook meeting invites and sends email notifications to both the Requestor and Meeting Provider.
1. On the Success screen, select **Return Home**.
