...
- [Review requirements to integrate SAP with Power Platform](finance/sap-procurement/administer/requirements).
- [Set up environments and DLP policies](finance/sap-procurement/administer/set-up-connections).
- [Set up an on-premises data gateway](finance/sap-procurement/administer/set-up-gateway).
- [Configure authentication](finance/sap-procurement/administer/configure-authentication).

Take these steps to install and set up the SAP Procurement template:

- [Install and set up the SAP Procurement solution](finance/sap-procurement/administer/install).
- [Configure environment variables](finance/sap-procurement/administer/configure-environment-variables).
- [Set up connections for SAP and Dataverse](finance/sap-procurement/administer/set-up-connections).
- [Set up SAP List of Values](finance/sap-procurement/administer/apply-seed-data#apply-saps-list-of-values).
...
Once you install both solutions, select **Publish all customizations**. Be sure to [set up connections for SAP and Dataverse](finance/sap-procurement/administer/set-up-connections.md).
