...
The schema DLP activity logging is deprecated and won't be available starting in XXXX. You can use the new schema available at [Activity category: Data policy events](admin-activity-logging.md#activity-category-data-policy-events).
