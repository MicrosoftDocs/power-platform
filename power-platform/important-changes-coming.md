...
Effective January 2024, Dynamics 365 for phones and tablets (iOS and Android) will only support on-premise users. Online users will need to migrate to the [Power Apps mobile app](/power-apps/mobile/run-powerapps-on-mobile). The Power Apps mobile app provides updated capabilities, a modern user experience, and fast load times.
