...
|Type|Guidance|
|---------|---------|
|Flows|If you can convert existing Flows to use the Dataverse (Current Environment) connector we recommend you do so.|
