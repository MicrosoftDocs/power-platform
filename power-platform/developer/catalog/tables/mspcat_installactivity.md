...
- [account_mspcat_InstallActivities](#BKMK_account_mspcat_InstallActivities)
- [activity_pointer_mspcat_InstallActivity](#BKMK_activity_pointer_mspcat_InstallActivity)
- [adx_invitation_mspcat_InstallActivities](#BKMK_adx_invitation_mspcat_InstallActivities)
- [contact_mspcat_InstallActivities](#BKMK_contact_mspcat_InstallActivities)
- [interactionforemail_mspcat_InstallActivities](#BKMK_interactionforemail_mspcat_InstallActivities)
- [knowledgearticle_mspcat_InstallActivities](#BKMK_knowledgearticle_mspcat_InstallActivities)
- [knowledgebaserecord_mspcat_InstallActivities](#BKMK_knowledgebaserecord_mspcat_InstallActivities)
...
- [mspcat_installactivity_mailbox_sendermailboxid](#BKMK_mspcat_installactivity_mailbox_sendermailboxid)
...
- [mspcat_installactivity_transactioncurrency_transactioncurrencyid](#BKMK_mspcat_installactivity_transactioncurrency_transactioncurrencyid)
...
- [mspp_adplacement_mspcat_InstallActivities](#BKMK_mspp_adplacement_mspcat_InstallActivities)
...
- [mspp_redirect_mspcat_InstallActivities](#BKMK_mspp_redirect_mspcat_InstallActivities)
- [mspp_shortcut_mspcat_InstallActivities](#BKMK_mspp_shortcut_mspcat_InstallActivities)
- [mspp_website_mspcat_InstallActivities](#BKMK_mspp_website_mspcat_InstallActivities)

### <a name="BKMK_account_mspcat_InstallActivities"></a> account_mspcat_InstallActivities

One-To-Many Relationship: [account account_mspcat_InstallActivities](account.md#BKMK_account_mspcat_InstallActivities)
...
|ReferencingEntityNavigationPropertyName|`regardingobjectid_account_mspcat_installactivity`|
|IsHierarchical||
...
One-To-Many Relationship: [activitypointer activity_pointer_mspcat_InstallActivity](activitypointer.md#BKMK_activity_pointer_mspcat_InstallActivity)
...
|ReferencingEntityNavigationPropertyName|`activityid_mspcat_installactivity`|
|IsHierarchical||
...
One-To-Many Relationship: [adx_invitation adx_invitation_mspcat_InstallActivities](adx_invitation.md#BKMK_adx_invitation_mspcat_InstallActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_adx_invitation_mspcat_installactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_contact_mspcat_InstallActivities"></a> contact_mspcat_InstallActivities

One-To-Many Relationship: [contact contact_mspcat_InstallActivities](contact.md#BKMK_contact_mspcat_InstallActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_contact_mspcat_installactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `Cascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_interactionforemail_mspcat_InstallActivities"></a> interactionforemail_mspcat_InstallActivities

One-To-Many Relationship: [interactionforemail interactionforemail_mspcat_InstallActivities](interactionforemail.md#BKMK_interactionforemail_mspcat_InstallActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_new_interactionforemail_mspcat_installactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_knowledgearticle_mspcat_InstallActivities"></a> knowledgearticle_mspcat_InstallActivities

One-To-Many Relationship: [knowledgearticle knowledgearticle_mspcat_InstallActivities](knowledgearticle.md#BKMK_knowledgearticle_mspcat_InstallActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_knowledgearticle_mspcat_installactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_knowledgebaserecord_mspcat_InstallActivities"></a> knowledgebaserecord_mspcat_InstallActivities

One-To-Many Relationship: [knowledgebaserecord knowledgebaserecord_mspcat_InstallActivities](knowledgebaserecord.md#BKMK_knowledgebaserecord_mspcat_InstallActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_knowledgebaserecord_mspcat_installactivity`|
|IsHierarchical||
...
One-To-Many Relationship: [businessunit mspcat_installactivity_businessunit_owningbusinessunit](businessunit.md#BKMK_mspcat_installactivity_businessunit_owningbusinessunit)
...
|ReferencingEntityNavigationPropertyName|`owningbusinessunit_mspcat_installactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `NoCascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_mspcat_installactivity_mailbox_sendermailboxid"></a> mspcat_installactivity_mailbox_sendermailboxid

One-To-Many Relationship: [mailbox mspcat_installactivity_mailbox_sendermailboxid](mailbox.md#BKMK_mspcat_installactivity_mailbox_sendermailboxid)
...
|ReferencingEntityNavigationPropertyName|`sendermailboxid_mspcat_installactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `NoCascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_mspcat_installactivity_owner_ownerid"></a> mspcat_installactivity_owner_ownerid

One-To-Many Relationship: [owner mspcat_installactivity_owner_ownerid](owner.md#BKMK_mspcat_installactivity_owner_ownerid)
...
|ReferencingEntityNavigationPropertyName|`ownerid_mspcat_installactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `NoCascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_mspcat_installactivity_sla_slaid"></a> mspcat_installactivity_sla_slaid

One-To-Many Relationship: [sla mspcat_installactivity_sla_slaid](sla.md#BKMK_mspcat_installactivity_sla_slaid)
...
|ReferencingEntityNavigationPropertyName|`sla_activitypointer_sla_mspcat_installactivity`|
|IsHierarchical||
...
One-To-Many Relationship: [sla mspcat_installactivity_sla_slainvokedid](sla.md#BKMK_mspcat_installactivity_sla_slainvokedid)
...
|ReferencingEntityNavigationPropertyName|`slainvokedid_activitypointer_sla_mspcat_installactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `RemoveLink`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_mspcat_installactivity_systemuser_createdby"></a> mspcat_installactivity_systemuser_createdby

One-To-Many Relationship: [systemuser mspcat_installactivity_systemuser_createdby](systemuser.md#BKMK_mspcat_installactivity_systemuser_createdby)
...
|ReferencingEntityNavigationPropertyName|`createdby_mspcat_installactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `NoCascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_mspcat_installactivity_systemuser_createdonbehalfby"></a> mspcat_installactivity_systemuser_createdonbehalfby

One-To-Many Relationship: [systemuser mspcat_installactivity_systemuser_createdonbehalfby](systemuser.md#BKMK_mspcat_installactivity_systemuser_createdonbehalfby)
...
|ReferencingEntityNavigationPropertyName|`createdonbehalfby_mspcat_installactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `NoCascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_mspcat_installactivity_systemuser_modifiedby"></a> mspcat_installactivity_systemuser_modifiedby

One-To-Many Relationship: [systemuser mspcat_installactivity_systemuser_modifiedby](systemuser.md#BKMK_mspcat_installactivity_systemuser_modifiedby)
...
|ReferencingEntityNavigationPropertyName|`modifiedby_mspcat_installactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `NoCascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_mspcat_installactivity_systemuser_modifiedonbehalfby"></a> mspcat_installactivity_systemuser_modifiedonbehalfby

One-To-Many Relationship: [systemuser mspcat_installactivity_systemuser_modifiedonbehalfby](systemuser.md#BKMK_mspcat_installactivity_systemuser_modifiedonbehalfby)
...
|ReferencingEntityNavigationPropertyName|`modifiedonbehalfby_mspcat_installactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `NoCascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_mspcat_installactivity_systemuser_owninguser"></a> mspcat_installactivity_systemuser_owninguser

One-To-Many Relationship: [systemuser mspcat_installactivity_systemuser_owninguser](systemuser.md#BKMK_mspcat_installactivity_systemuser_owninguser)
...
|ReferencingEntityNavigationPropertyName|`owninguser_mspcat_installactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `NoCascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_mspcat_installactivity_team_owningteam"></a> mspcat_installactivity_team_owningteam

One-To-Many Relationship: [team mspcat_installactivity_team_owningteam](team.md#BKMK_mspcat_installactivity_team_owningteam)
...
|ReferencingEntityNavigationPropertyName|`owningteam_mspcat_installactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `NoCascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
One-To-Many Relationship: [transactioncurrency mspcat_installactivity_transactioncurrency_transactioncurrencyid](transactioncurrency.md#BKMK_mspcat_installactivity_transactioncurrency_transactioncurrencyid)
...
|ReferencingEntityNavigationPropertyName|`transactioncurrencyid_mspcat_installactivity`|
|IsHierarchical||
...
One-To-Many Relationship: [mspp_adplacement mspp_adplacement_mspcat_InstallActivities](mspp_adplacement.md#BKMK_mspp_adplacement_mspcat_InstallActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_mspp_adplacement_mspcat_installactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
### <a name="BKMK_mspp_redirect_mspcat_InstallActivities"></a> mspp_redirect_mspcat_InstallActivities

One-To-Many Relationship: [mspp_redirect mspp_redirect_mspcat_InstallActivities](mspp_redirect.md#BKMK_mspp_redirect_mspcat_InstallActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_mspp_redirect_mspcat_installactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_mspp_shortcut_mspcat_InstallActivities"></a> mspp_shortcut_mspcat_InstallActivities

One-To-Many Relationship: [mspp_shortcut mspp_shortcut_mspcat_InstallActivities](mspp_shortcut.md#BKMK_mspp_shortcut_mspcat_InstallActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_mspp_shortcut_mspcat_installactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_mspp_website_mspcat_InstallActivities"></a> mspp_website_mspcat_InstallActivities

One-To-Many Relationship: [mspp_website mspp_website_mspcat_InstallActivities](mspp_website.md#BKMK_mspp_website_mspcat_InstallActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_mspp_website_mspcat_installactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
- [mspcat_installactivity_ActionCards](#BKMK_mspcat_installactivity_ActionCards)
- [mspcat_InstallActivity_activity_parties](#BKMK_mspcat_InstallActivity_activity_parties)
...
Many-To-One Relationship: [actioncard mspcat_installactivity_ActionCards](actioncard.md#BKMK_mspcat_installactivity_ActionCards)

|Property|Value|
|---|---|
|ReferencingEntity|`actioncard`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`mspcat_installactivity_ActionCards`|
|IsCustomizable|`True`|
...
Many-To-One Relationship: [activityparty mspcat_InstallActivity_activity_parties](activityparty.md#BKMK_mspcat_InstallActivity_activity_parties)

|Property|Value|
|---|---|
|ReferencingEntity|`activityparty`|
|ReferencingAttribute|`activityid`|
|ReferencedEntityNavigationPropertyName|`mspcat_InstallActivity_activity_parties`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_mspcat_installactivity_Annotations"></a> mspcat_installactivity_Annotations

Many-To-One Relationship: [annotation mspcat_installactivity_Annotations](annotation.md#BKMK_mspcat_installactivity_Annotations)

|Property|Value|
|---|---|
|ReferencingEntity|`annotation`|
|ReferencingAttribute|`objectid`|
|ReferencedEntityNavigationPropertyName|`mspcat_installactivity_Annotations`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_mspcat_installactivity_AsyncOperations"></a> mspcat_installactivity_AsyncOperations

Many-To-One Relationship: [asyncoperation mspcat_installactivity_AsyncOperations](asyncoperation.md#BKMK_mspcat_installactivity_AsyncOperations)

|Property|Value|
|---|---|
|ReferencingEntity|`asyncoperation`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`mspcat_installactivity_AsyncOperations`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_mspcat_installactivity_BulkDeleteFailures"></a> mspcat_installactivity_BulkDeleteFailures

Many-To-One Relationship: [bulkdeletefailure mspcat_installactivity_BulkDeleteFailures](bulkdeletefailure.md#BKMK_mspcat_installactivity_BulkDeleteFailures)

|Property|Value|
|---|---|
|ReferencingEntity|`bulkdeletefailure`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`mspcat_installactivity_BulkDeleteFailures`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_mspcat_installactivity_connections1"></a> mspcat_installactivity_connections1

Many-To-One Relationship: [connection mspcat_installactivity_connections1](connection.md#BKMK_mspcat_installactivity_connections1)

|Property|Value|
|---|---|
|ReferencingEntity|`connection`|
|ReferencingAttribute|`record1id`|
|ReferencedEntityNavigationPropertyName|`mspcat_installactivity_connections1`|
|IsCustomizable|`True`|
...
Many-To-One Relationship: [connection mspcat_installactivity_connections2](connection.md#BKMK_mspcat_installactivity_connections2)

|Property|Value|
|---|---|
|ReferencingEntity|`connection`|
|ReferencingAttribute|`record2id`|
|ReferencedEntityNavigationPropertyName|`mspcat_installactivity_connections2`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_mspcat_installactivity_DuplicateBaseRecord"></a> mspcat_installactivity_DuplicateBaseRecord

Many-To-One Relationship: [duplicaterecord mspcat_installactivity_DuplicateBaseRecord](duplicaterecord.md#BKMK_mspcat_installactivity_DuplicateBaseRecord)

|Property|Value|
|---|---|
|ReferencingEntity|`duplicaterecord`|
|ReferencingAttribute|`baserecordid`|
|ReferencedEntityNavigationPropertyName|`mspcat_installactivity_DuplicateBaseRecord`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_mspcat_installactivity_DuplicateMatchingRecord"></a> mspcat_installactivity_DuplicateMatchingRecord

Many-To-One Relationship: [duplicaterecord mspcat_installactivity_DuplicateMatchingRecord](duplicaterecord.md#BKMK_mspcat_installactivity_DuplicateMatchingRecord)

|Property|Value|
|---|---|
|ReferencingEntity|`duplicaterecord`|
|ReferencingAttribute|`duplicaterecordid`|
|ReferencedEntityNavigationPropertyName|`mspcat_installactivity_DuplicateMatchingRecord`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_mspcat_installactivity_Feedback"></a> mspcat_installactivity_Feedback

Many-To-One Relationship: [feedback mspcat_installactivity_Feedback](feedback.md#BKMK_mspcat_installactivity_Feedback)

|Property|Value|
|---|---|
|ReferencingEntity|`feedback`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`mspcat_installactivity_Feedback`|
|IsCustomizable|`True`|
...
Many-To-One Relationship: [mailboxtrackingfolder mspcat_installactivity_MailboxTrackingFolders](mailboxtrackingfolder.md#BKMK_mspcat_installactivity_MailboxTrackingFolders)

|Property|Value|
|---|---|
|ReferencingEntity|`mailboxtrackingfolder`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`mspcat_installactivity_MailboxTrackingFolders`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|
...
Many-To-One Relationship: [principalobjectattributeaccess mspcat_installactivity_PrincipalObjectAttributeAccesses](principalobjectattributeaccess.md#BKMK_mspcat_installactivity_PrincipalObjectAttributeAccesses)

|Property|Value|
|---|---|
|ReferencingEntity|`principalobjectattributeaccess`|
|ReferencingAttribute|`objectid`|
|ReferencedEntityNavigationPropertyName|`mspcat_installactivity_PrincipalObjectAttributeAccesses`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_mspcat_installactivity_ProcessSession"></a> mspcat_installactivity_ProcessSession

Many-To-One Relationship: [processsession mspcat_installactivity_ProcessSession](processsession.md#BKMK_mspcat_installactivity_ProcessSession)

|Property|Value|
|---|---|
|ReferencingEntity|`processsession`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`mspcat_installactivity_ProcessSession`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_mspcat_installactivity_QueueItems"></a> mspcat_installactivity_QueueItems

Many-To-One Relationship: [queueitem mspcat_installactivity_QueueItems](queueitem.md#BKMK_mspcat_installactivity_QueueItems)

|Property|Value|
|---|---|
|ReferencingEntity|`queueitem`|
|ReferencingAttribute|`objectid`|
|ReferencedEntityNavigationPropertyName|`mspcat_installactivity_QueueItems`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_mspcat_installactivity_SyncErrors"></a> mspcat_installactivity_SyncErrors

Many-To-One Relationship: [syncerror mspcat_installactivity_SyncErrors](syncerror.md#BKMK_mspcat_installactivity_SyncErrors)

|Property|Value|
|---|---|
|ReferencingEntity|`syncerror`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`mspcat_installactivity_SyncErrors`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|
