...
One-To-Many Relationship: [systemuser lk_mspcat_crmgeo_createdby](systemuser.md#BKMK_lk_mspcat_crmgeo_createdby)
...
One-To-Many Relationship: [systemuser lk_mspcat_crmgeo_createdonbehalfby](systemuser.md#BKMK_lk_mspcat_crmgeo_createdonbehalfby)
...
One-To-Many Relationship: [systemuser lk_mspcat_crmgeo_modifiedby](systemuser.md#BKMK_lk_mspcat_crmgeo_modifiedby)
...
One-To-Many Relationship: [systemuser lk_mspcat_crmgeo_modifiedonbehalfby](systemuser.md#BKMK_lk_mspcat_crmgeo_modifiedonbehalfby)
...
One-To-Many Relationship: [organization organization_mspcat_crmgeo](organization.md#BKMK_organization_mspcat_crmgeo)
...
Many-To-One Relationship: [annotation mspcat_crmgeo_Annotations](annotation.md#BKMK_mspcat_crmgeo_Annotations)

|Property|Value|
|---|---|
|ReferencingEntity|`annotation`|
|ReferencingAttribute|`objectid`|
|ReferencedEntityNavigationPropertyName|`mspcat_crmgeo_Annotations`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_mspcat_crmgeo_AsyncOperations"></a> mspcat_crmgeo_AsyncOperations

Many-To-One Relationship: [asyncoperation mspcat_crmgeo_AsyncOperations](asyncoperation.md#BKMK_mspcat_crmgeo_AsyncOperations)

|Property|Value|
|---|---|
|ReferencingEntity|`asyncoperation`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`mspcat_crmgeo_AsyncOperations`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_mspcat_crmgeo_BulkDeleteFailures"></a> mspcat_crmgeo_BulkDeleteFailures

Many-To-One Relationship: [bulkdeletefailure mspcat_crmgeo_BulkDeleteFailures](bulkdeletefailure.md#BKMK_mspcat_crmgeo_BulkDeleteFailures)

|Property|Value|
|---|---|
|ReferencingEntity|`bulkdeletefailure`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`mspcat_crmgeo_BulkDeleteFailures`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_mspcat_crmgeo_connections1"></a> mspcat_crmgeo_connections1

Many-To-One Relationship: [connection mspcat_crmgeo_connections1](connection.md#BKMK_mspcat_crmgeo_connections1)

|Property|Value|
|---|---|
|ReferencingEntity|`connection`|
|ReferencingAttribute|`record1id`|
|ReferencedEntityNavigationPropertyName|`mspcat_crmgeo_connections1`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `UseCollectionName`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: 100<br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_mspcat_crmgeo_connections2"></a> mspcat_crmgeo_connections2

Many-To-One Relationship: [connection mspcat_crmgeo_connections2](connection.md#BKMK_mspcat_crmgeo_connections2)

|Property|Value|
|---|---|
|ReferencingEntity|`connection`|
|ReferencingAttribute|`record2id`|
|ReferencedEntityNavigationPropertyName|`mspcat_crmgeo_connections2`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_mspcat_crmgeo_DuplicateBaseRecord"></a> mspcat_crmgeo_DuplicateBaseRecord

Many-To-One Relationship: [duplicaterecord mspcat_crmgeo_DuplicateBaseRecord](duplicaterecord.md#BKMK_mspcat_crmgeo_DuplicateBaseRecord)

|Property|Value|
|---|---|
|ReferencingEntity|`duplicaterecord`|
|ReferencingAttribute|`baserecordid`|
|ReferencedEntityNavigationPropertyName|`mspcat_crmgeo_DuplicateBaseRecord`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_mspcat_crmgeo_DuplicateMatchingRecord"></a> mspcat_crmgeo_DuplicateMatchingRecord

Many-To-One Relationship: [duplicaterecord mspcat_crmgeo_DuplicateMatchingRecord](duplicaterecord.md#BKMK_mspcat_crmgeo_DuplicateMatchingRecord)

|Property|Value|
|---|---|
|ReferencingEntity|`duplicaterecord`|
|ReferencingAttribute|`duplicaterecordid`|
|ReferencedEntityNavigationPropertyName|`mspcat_crmgeo_DuplicateMatchingRecord`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_mspcat_crmgeo_MailboxTrackingFolders"></a> mspcat_crmgeo_MailboxTrackingFolders

Many-To-One Relationship: [mailboxtrackingfolder mspcat_crmgeo_MailboxTrackingFolders](mailboxtrackingfolder.md#BKMK_mspcat_crmgeo_MailboxTrackingFolders)

|Property|Value|
|---|---|
|ReferencingEntity|`mailboxtrackingfolder`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`mspcat_crmgeo_MailboxTrackingFolders`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_mspcat_crmgeo_PrincipalObjectAttributeAccesses"></a> mspcat_crmgeo_PrincipalObjectAttributeAccesses

Many-To-One Relationship: [principalobjectattributeaccess mspcat_crmgeo_PrincipalObjectAttributeAccesses](principalobjectattributeaccess.md#BKMK_mspcat_crmgeo_PrincipalObjectAttributeAccesses)

|Property|Value|
|---|---|
|ReferencingEntity|`principalobjectattributeaccess`|
|ReferencingAttribute|`objectid`|
|ReferencedEntityNavigationPropertyName|`mspcat_crmgeo_PrincipalObjectAttributeAccesses`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_mspcat_crmgeo_ProcessSession"></a> mspcat_crmgeo_ProcessSession

Many-To-One Relationship: [processsession mspcat_crmgeo_ProcessSession](processsession.md#BKMK_mspcat_crmgeo_ProcessSession)

|Property|Value|
|---|---|
|ReferencingEntity|`processsession`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`mspcat_crmgeo_ProcessSession`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_mspcat_crmgeo_SyncErrors"></a> mspcat_crmgeo_SyncErrors

Many-To-One Relationship: [syncerror mspcat_crmgeo_SyncErrors](syncerror.md#BKMK_mspcat_crmgeo_SyncErrors)

|Property|Value|
|---|---|
|ReferencingEntity|`syncerror`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`mspcat_crmgeo_SyncErrors`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|
