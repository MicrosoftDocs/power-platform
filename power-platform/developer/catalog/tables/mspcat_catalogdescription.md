...
One-To-Many Relationship: [systemuser lk_mspcat_catalogdescription_createdby](systemuser.md#BKMK_lk_mspcat_catalogdescription_createdby)
...
One-To-Many Relationship: [systemuser lk_mspcat_catalogdescription_createdonbehalfby](systemuser.md#BKMK_lk_mspcat_catalogdescription_createdonbehalfby)
...
One-To-Many Relationship: [systemuser lk_mspcat_catalogdescription_modifiedby](systemuser.md#BKMK_lk_mspcat_catalogdescription_modifiedby)
...
One-To-Many Relationship: [systemuser lk_mspcat_catalogdescription_modifiedonbehalfby](systemuser.md#BKMK_lk_mspcat_catalogdescription_modifiedonbehalfby)
...
One-To-Many Relationship: [organization organization_mspcat_catalogdescription](organization.md#BKMK_organization_mspcat_catalogdescription)
...
Many-To-One Relationship: [asyncoperation mspcat_catalogdescription_AsyncOperations](asyncoperation.md#BKMK_mspcat_catalogdescription_AsyncOperations)

|Property|Value|
|---|---|
|ReferencingEntity|`asyncoperation`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`mspcat_catalogdescription_AsyncOperations`|
|IsCustomizable|`True`|
...
Many-To-One Relationship: [bulkdeletefailure mspcat_catalogdescription_BulkDeleteFailures](bulkdeletefailure.md#BKMK_mspcat_catalogdescription_BulkDeleteFailures)

|Property|Value|
|---|---|
|ReferencingEntity|`bulkdeletefailure`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`mspcat_catalogdescription_BulkDeleteFailures`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_mspcat_catalogdescription_DuplicateBaseRecord"></a> mspcat_catalogdescription_DuplicateBaseRecord

Many-To-One Relationship: [duplicaterecord mspcat_catalogdescription_DuplicateBaseRecord](duplicaterecord.md#BKMK_mspcat_catalogdescription_DuplicateBaseRecord)

|Property|Value|
|---|---|
|ReferencingEntity|`duplicaterecord`|
|ReferencingAttribute|`baserecordid`|
|ReferencedEntityNavigationPropertyName|`mspcat_catalogdescription_DuplicateBaseRecord`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_mspcat_catalogdescription_DuplicateMatchingRecord"></a> mspcat_catalogdescription_DuplicateMatchingRecord

Many-To-One Relationship: [duplicaterecord mspcat_catalogdescription_DuplicateMatchingRecord](duplicaterecord.md#BKMK_mspcat_catalogdescription_DuplicateMatchingRecord)

|Property|Value|
|---|---|
|ReferencingEntity|`duplicaterecord`|
|ReferencingAttribute|`duplicaterecordid`|
|ReferencedEntityNavigationPropertyName|`mspcat_catalogdescription_DuplicateMatchingRecord`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_mspcat_catalogdescription_MailboxTrackingFolders"></a> mspcat_catalogdescription_MailboxTrackingFolders

Many-To-One Relationship: [mailboxtrackingfolder mspcat_catalogdescription_MailboxTrackingFolders](mailboxtrackingfolder.md#BKMK_mspcat_catalogdescription_MailboxTrackingFolders)

|Property|Value|
|---|---|
|ReferencingEntity|`mailboxtrackingfolder`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`mspcat_catalogdescription_MailboxTrackingFolders`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|
...
Many-To-One Relationship: [principalobjectattributeaccess mspcat_catalogdescription_PrincipalObjectAttributeAccesses](principalobjectattributeaccess.md#BKMK_mspcat_catalogdescription_PrincipalObjectAttributeAccesses)

|Property|Value|
|---|---|
|ReferencingEntity|`principalobjectattributeaccess`|
|ReferencingAttribute|`objectid`|
|ReferencedEntityNavigationPropertyName|`mspcat_catalogdescription_PrincipalObjectAttributeAccesses`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_mspcat_catalogdescription_ProcessSession"></a> mspcat_catalogdescription_ProcessSession

Many-To-One Relationship: [processsession mspcat_catalogdescription_ProcessSession](processsession.md#BKMK_mspcat_catalogdescription_ProcessSession)

|Property|Value|
|---|---|
|ReferencingEntity|`processsession`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`mspcat_catalogdescription_ProcessSession`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_mspcat_catalogdescription_SyncErrors"></a> mspcat_catalogdescription_SyncErrors

Many-To-One Relationship: [syncerror mspcat_catalogdescription_SyncErrors](syncerror.md#BKMK_mspcat_catalogdescription_SyncErrors)

|Property|Value|
|---|---|
|ReferencingEntity|`syncerror`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`mspcat_catalogdescription_SyncErrors`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|
