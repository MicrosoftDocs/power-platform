...
One-To-Many Relationship: [businessunit business_unit_mspcat_catalogitemfile](businessunit.md#BKMK_business_unit_mspcat_catalogitemfile)
...
One-To-Many Relationship: [fileattachment FileAttachment_mspcat_CatalogItemFile_mspcat_File](fileattachment.md#BKMK_FileAttachment_mspcat_CatalogItemFile_mspcat_File)
...
One-To-Many Relationship: [systemuser lk_mspcat_catalogitemfile_createdby](systemuser.md#BKMK_lk_mspcat_catalogitemfile_createdby)
...
One-To-Many Relationship: [systemuser lk_mspcat_catalogitemfile_createdonbehalfby](systemuser.md#BKMK_lk_mspcat_catalogitemfile_createdonbehalfby)
...
One-To-Many Relationship: [systemuser lk_mspcat_catalogitemfile_modifiedby](systemuser.md#BKMK_lk_mspcat_catalogitemfile_modifiedby)
...
One-To-Many Relationship: [systemuser lk_mspcat_catalogitemfile_modifiedonbehalfby](systemuser.md#BKMK_lk_mspcat_catalogitemfile_modifiedonbehalfby)
...
One-To-Many Relationship: [owner owner_mspcat_catalogitemfile](owner.md#BKMK_owner_mspcat_catalogitemfile)
...
One-To-Many Relationship: [team team_mspcat_catalogitemfile](team.md#BKMK_team_mspcat_catalogitemfile)
...
One-To-Many Relationship: [systemuser user_mspcat_catalogitemfile](systemuser.md#BKMK_user_mspcat_catalogitemfile)
...
Many-To-One Relationship: [asyncoperation mspcat_catalogitemfile_AsyncOperations](asyncoperation.md#BKMK_mspcat_catalogitemfile_AsyncOperations)

|Property|Value|
|---|---|
|ReferencingEntity|`asyncoperation`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`mspcat_catalogitemfile_AsyncOperations`|
|IsCustomizable|`True`|
...
Many-To-One Relationship: [bulkdeletefailure mspcat_catalogitemfile_BulkDeleteFailures](bulkdeletefailure.md#BKMK_mspcat_catalogitemfile_BulkDeleteFailures)

|Property|Value|
|---|---|
|ReferencingEntity|`bulkdeletefailure`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`mspcat_catalogitemfile_BulkDeleteFailures`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_mspcat_catalogitemfile_DuplicateBaseRecord"></a> mspcat_catalogitemfile_DuplicateBaseRecord

Many-To-One Relationship: [duplicaterecord mspcat_catalogitemfile_DuplicateBaseRecord](duplicaterecord.md#BKMK_mspcat_catalogitemfile_DuplicateBaseRecord)

|Property|Value|
|---|---|
|ReferencingEntity|`duplicaterecord`|
|ReferencingAttribute|`baserecordid`|
|ReferencedEntityNavigationPropertyName|`mspcat_catalogitemfile_DuplicateBaseRecord`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_mspcat_catalogitemfile_DuplicateMatchingRecord"></a> mspcat_catalogitemfile_DuplicateMatchingRecord

Many-To-One Relationship: [duplicaterecord mspcat_catalogitemfile_DuplicateMatchingRecord](duplicaterecord.md#BKMK_mspcat_catalogitemfile_DuplicateMatchingRecord)

|Property|Value|
|---|---|
|ReferencingEntity|`duplicaterecord`|
|ReferencingAttribute|`duplicaterecordid`|
|ReferencedEntityNavigationPropertyName|`mspcat_catalogitemfile_DuplicateMatchingRecord`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_mspcat_catalogitemfile_FileAttachments"></a> mspcat_catalogitemfile_FileAttachments

Many-To-One Relationship: [fileattachment mspcat_catalogitemfile_FileAttachments](fileattachment.md#BKMK_mspcat_catalogitemfile_FileAttachments)

|Property|Value|
|---|---|
|ReferencingEntity|`fileattachment`|
|ReferencingAttribute|`objectid`|
|ReferencedEntityNavigationPropertyName|`mspcat_catalogitemfile_FileAttachments`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_mspcat_catalogitemfile_MailboxTrackingFolders"></a> mspcat_catalogitemfile_MailboxTrackingFolders

Many-To-One Relationship: [mailboxtrackingfolder mspcat_catalogitemfile_MailboxTrackingFolders](mailboxtrackingfolder.md#BKMK_mspcat_catalogitemfile_MailboxTrackingFolders)

|Property|Value|
|---|---|
|ReferencingEntity|`mailboxtrackingfolder`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`mspcat_catalogitemfile_MailboxTrackingFolders`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|
...
Many-To-One Relationship: [principalobjectattributeaccess mspcat_catalogitemfile_PrincipalObjectAttributeAccesses](principalobjectattributeaccess.md#BKMK_mspcat_catalogitemfile_PrincipalObjectAttributeAccesses)

|Property|Value|
|---|---|
|ReferencingEntity|`principalobjectattributeaccess`|
|ReferencingAttribute|`objectid`|
|ReferencedEntityNavigationPropertyName|`mspcat_catalogitemfile_PrincipalObjectAttributeAccesses`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_mspcat_catalogitemfile_ProcessSession"></a> mspcat_catalogitemfile_ProcessSession

Many-To-One Relationship: [processsession mspcat_catalogitemfile_ProcessSession](processsession.md#BKMK_mspcat_catalogitemfile_ProcessSession)

|Property|Value|
|---|---|
|ReferencingEntity|`processsession`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`mspcat_catalogitemfile_ProcessSession`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_mspcat_catalogitemfile_SyncErrors"></a> mspcat_catalogitemfile_SyncErrors

Many-To-One Relationship: [syncerror mspcat_catalogitemfile_SyncErrors](syncerror.md#BKMK_mspcat_catalogitemfile_SyncErrors)

|Property|Value|
|---|---|
|ReferencingEntity|`syncerror`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`mspcat_catalogitemfile_SyncErrors`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|
