...
:::image type="content" source="media/catalog_submission.png" alt-text="Catalog submission":::

> [!NOTE]
> This option will be disabled for managed solutions, as you cannot submit managed solutions into the catalog. Coming soon will be the capability to publish catalog items via pipelines. This will be the recommended method to follow proper ALM.
...
:::image type="content" source="media/add_to_solution.png" alt-text="Add to solution":::
...
:::image type="content" source="media/access_error_submission.png" alt-text="Catalog submission access error":::
...
1. **Step 2 (Catalog)**
   ...
   1. Description: provide details on this catalog item. Makers will read your description in the catalog gallery to find out more about it.
   1. Business justification: by default, all catalog submissions must be approved by your admin before they are added to the catalog. This field provides a justification for your submission to your admin.
   1. Works with: a flow that you're building may be intended to **work with** canvas apps and model apps, for example. Indicate here what your catalog item is intended to work with.
   1. Select business categories: select up to five business categories that describe your catalog item. Makers will use these categories to search for catalog items that are of interest to them.
   1. Publisher: select an existing publisher in this environment, or create a new publisher, to connect to this catalog submission. NOTE: a maker cannot resubmit a catalog item unless they are part of the publishing group that submitted the item the first time.
   1. Author: this is defaulted to the current user, but can be changed if needed

1. **Step 3 (Solution info)**

   1. Add your solution icon: you can attach an icon to your solution (216x216px) to help identify it in the catalog gallery
   1. Add your template images: you can attach some screenshots or other visuals that can help makers understand more details about this catalog item
   1. Help link: add the URL for any help documentation as needed
   1. Privacy policy link: add the URL for any privacy policy documentation as needed
   1. Legal terms link: add the URL for any legal terms documentation as needed

1. **Step 4 (Review + finish)**
...
:::image type="content" source="media/catalog_item.png" alt-text="Catalog item tile":::
