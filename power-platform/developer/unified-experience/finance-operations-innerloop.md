...
For example, if you want to add a license file `licenseFile01` for **Module01** at `E:\ISVModules\Module01`, create a child folder `E:\ISVModules\Module01\__License` and place the file in it as `E:\ISVModules\Module01\__License\licenseFile01`. You also need to perform a **Full DB Sync** from the Dynamics 365 menu in **Extensions** for the license to take effect.
...
## Deploy packages while the environment is in administration mode
