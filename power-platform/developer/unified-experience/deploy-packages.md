...
Download the X++ Nuget packages with the required version and add them to your artifact feed. Reference: [Build automation that uses Microsoft-hosted agents and Azure Pipelines](Dynamics-365-Operations/articles/fin-ops-core/dev-itpro/dev-tools/hosted-build-automation.md)
