---
title: "Power Apps Developer Plan Guide: Features and Benefits"
description: "Learn about the Power Apps Developer Plan features, capacity limits, and how to get started with free development tools for building apps and flows."
author: MKBajwa-PM
...
The Power Apps Developer Plan provides a free development environment to build and test applications with Power Apps, Power Automate, and Microsoft Dataverse. This comprehensive plan enables you to:
...
benefits](https://my.visualstudio.com/benefits) and select the Power Apps tile to sign up for the Power Apps Developer Plan.
    ...
    ![Power Apps Developer Plan in Visual Studio.](media/developer-plan-developer-essentials.png "Power Apps Developer Plan in Visual Studio")

## Which features does the Power Apps Developer Plan include?

When you use the developer environment, you get the following functionality:
...
| **Connectivity**||
| Connect to Microsoft 365, Dynamics 365, and other connectors| Yes|
...
| Access on-premises data by using an on-premises gateway| Yes|
| Create custom connectors to connect to your own systems| Yes|
| **Dataverse**||
| Create and run applications in Power Platform, Dynamics 365, Teams, or standalone by using the .NET SDK or OData Web API | Yes|
...
| Supports data policies established by the Microsoft 365 administrator| Yes|
...
You can't increase capacity by applying add-ons to the quantities we include. If you hit capacity limits, purchase the Power Apps Per User Plan. For more information, see the [Power Apps pricing page](https://powerapps.microsoft.com/pricing/).

> [!NOTE]
> The capacity entitlements of the developer environment, whether used or not, don't contribute to your company's overall quota.

## Publishing to Microsoft Marketplace

Do you have an app that you'd like to share with customers? Power Apps solutions on [Microsoft Marketplace](https://marketplace.microsoft.com/) are now supported as a way for you to share apps and flows with customers, and generate leads for your
...
Both Power Apps Plan Trial and Power Apps Developer Plan are free, but they're created for different purposes:
...
No, you currently can't sign up with a personal account. You can only sign up with your [work or school
...
No. However, users can start a Power Automate trial that includes RPA use rights to try out RPA capabilities. The Power Apps Developer plan includes cloud flow use rights since these can be connected to and act as an extension of Power Apps apps.

### Does the Power Apps Developer plan include AI Builder use rights?

No. However, users can start an AI Builder trial to try out the AI Builder capabilities.

### Can a developer environment be a managed environment?

A developer environment can become a managed environment. However, managed environment use rights aren't included in the developer plan. As a result, end users require premium licenses to run their assets in a managed developer environment.

### Why does a banner appear with apps running in the developer environment?

Since developer environments aren't intended to support production scenarios, apps display a temporary banner to remind makers about them running in a developer environment. This banner no longer appears if you move the app from a developer environment to a non-developer environment.
...
No. Dynamics 365 apps can't be installed in a developer environment. You see the following message when you try to install them:

"Installing Dynamics 365 apps such as Dynamics 365 Sales and Dynamics 365 Customer Service is only supported on environments that are created with a database with the option to Enable Dynamics 365 apps set to "Yes". Try installing this application in an environment with a database and Enable Dynamics 365 apps enabled on it."
...
No. Users aren't automatically added to the developer environment. You need to add them manually.

## Improvements from the previous Power Apps Community Plan

In May 2021, Microsoft extended the capabilities of the Power Apps Community Plan to meet the needs of developers and rebranded it as the **Power Apps Developer Plan**.
...
> [!NOTE]
> Existing Power Apps Community Plan users also get all of these updates.
