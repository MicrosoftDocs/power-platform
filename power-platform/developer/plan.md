...
Anyone with a [work or school email address](/power-apps/maker/signup-for-powerapps#faq) backed by [Entra ID](/azure/active-directory/fundamentals/sign-up-organization) can sign up for the Power Apps Developer Plan.
