...
This example prompts you for credentials and connects to the tenant the credentials belong to.
...
> [!NOTE]
> When running Power Platform CLI in Codespaces, this operation triggers a device code login.

#### Environment Create

This example prompts you for credentials and connects to the Power Platform environment with environment ID you specify.
