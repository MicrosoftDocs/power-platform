...
no-loc: [ "pac", "pac solution", "solution add-license", "solution add-reference", "solution add-solution-component", "solution check", "solution clone", "solution create-settings", "solution delete", "solution export", "solution import", "solution init", "solution list", "solution online-version", "solution pack", "solution publish", "solution sync", "solution unpack", "solution upgrade", "solution version"]
---
<!-- 
