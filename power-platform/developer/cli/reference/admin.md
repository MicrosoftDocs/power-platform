...
contributors: 
 - JimDaly
no-loc: ["pac", "admin", "add-group", "application list", "application register", "application unregister", "assign-group", "assign-user", "backup", "copy", "create", "create-service-principal", "delete", "list", "list-app-templates", "list-backups", "list-groups", "list-service-principal", "list-tenant-settings", "reset", "restore", "set-backup-retention-period", "set-governance-config", "set-runtime-state", "status", "update-tenant-settings"]
---
<!-- 
