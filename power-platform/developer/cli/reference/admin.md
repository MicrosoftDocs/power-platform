...
no-loc: [ "pac", "pac admin", "admin add-group", "admin application list", "admin application register", "admin application unregister", "admin assign-group", "admin assign-user", "admin backup", "admin copy", "admin create", "admin create-service-principal", "admin delete", "admin dlp-policy list", "admin dlp-policy show", "admin list", "admin list-app-templates", "admin list-backups", "admin list-groups", "admin list-roles", "admin list-service-principal", "admin list-tenant-settings", "admin query", "admin reset", "admin restore", "admin self-elevate", "admin set-backup-retention-period", "admin set-governance-config", "admin set-runtime-state", "admin status", "admin update-tenant-settings"]
---
<!-- 
...
|[pac admin dlp-policy list](#pac-admin-dlp-policy-list)|List DLP policies in the tenant.|
|[pac admin dlp-policy show](#pac-admin-dlp-policy-show)|Show details of a specific DLP policy.|
...
|[pac admin list-roles](#pac-admin-list-roles)|List security roles from a Dataverse environment.|
...
|[pac admin query](#pac-admin-query)|Run tenant-level resource query.|
...
|[pac admin self-elevate](#pac-admin-self-elevate)|Self-elevate to System Administrator role in an environment (requires Global admin, Power Platform admin, or Dynamics 365 admin).|
...
[!INCLUDE [admin-dlp-policy-list-remarks](includes/admin-dlp-policy-list-remarks.md)]

## pac admin dlp-policy show

Show details of a specific DLP policy.

[!INCLUDE [admin-dlp-policy-show-intro](includes/admin-dlp-policy-show-intro.md)]


### Required Parameters for admin dlp-policy show

#### `--policy-name` `-pn`

The policy name (GUID identifier).

[!INCLUDE [admin-dlp-policy-show-remarks](includes/admin-dlp-policy-show-remarks.md)]
...
List security roles from a Dataverse environment.

[!INCLUDE [admin-list-roles-intro](includes/admin-list-roles-intro.md)]


### Optional Parameters for admin list-roles

#### `--business-unit` `-bu`

Name or ID of business unit to filter security roles by.

#### `--environment` `-env`

ID or URL of the environment to list security roles from.

#### `--include-child-roles`

Include child security roles. By default, only parent security roles are listed.

This parameter requires no value. It's a switch.

[!INCLUDE [admin-list-roles-remarks](includes/admin-list-roles-remarks.md)]
...
Run tenant-level resource query.

[!INCLUDE [admin-query-intro](includes/admin-query-intro.md)]


### Optional Parameters for admin query

#### `--output-file` `-of`

Path to save query results. Format depends on --output-type: raw JSON for Json, simple text for List, and CSV for Grid.

#### `--output-type` `-ot`

Output type for query results (Defaults to Grid)
...
Resource Query JSON as a string.

#### `--query-file` `-qf`

Path to a JSON file containing the Resource Query.

[!INCLUDE [admin-query-remarks](includes/admin-query-remarks.md)]
...
Self-elevate to System Administrator role in an environment (requires Global admin, Power Platform admin, or Dynamics 365 admin).

[!INCLUDE [admin-self-elevate-intro](includes/admin-self-elevate-intro.md)]


### Optional Parameters for admin self-elevate

#### `--environment` `-env`

Specifies the target Dataverse. The value may be a Guid or absolute https URL. When not specified, the active organization selected for the current auth profile will be used.

[!INCLUDE [admin-self-elevate-remarks](includes/admin-self-elevate-remarks.md)]
