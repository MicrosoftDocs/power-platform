...
no-loc: [ "pac", "pac admin", "admin add-group", "admin application list", "admin application register", "admin application unregister", "admin assign-group", "admin assign-user", "admin backup", "admin copy", "admin create", "admin create-service-principal", "admin delete", "admin list", "admin list-app-templates", "admin list-backups", "admin list-groups", "admin list-service-principal", "admin list-tenant-settings", "admin reset", "admin restore", "admin set-backup-retention-period", "admin set-governance-config", "admin set-runtime-state", "admin status", "admin update-tenant-settings"]
---
<!-- 
