...
no-loc: [ "pac", "pac auth", "auth clear", "auth create", "auth delete", "auth list", "auth name", "auth select", "auth token", "auth update", "auth who"]
---
<!-- 
...
|[pac auth token](#pac-auth-token)|Display a Power Platform API access token for the currently selected authentication profile|
...
Display a Power Platform API access token for the currently selected authentication profile

[!INCLUDE [auth-token-remarks](includes/auth-token-remarks.md)]
