...
no-loc: ["pac admin", "pac application", "pac auth", "pac canvas", "pac catalog", "pac code", "pac connection", "pac connector", "pac copilot", "pac data", "pac env", "pac help", "pac managed-identity", "pac modelbuilder", "pac package", "pac pages", "pac pcf", "pac pipeline", "pac plugin", "pac power-fx", "pac solution", "pac telemetry", "pac test", "pac tool"]
