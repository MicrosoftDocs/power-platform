---
title: Install and Configure Microsoft Power Platform CLI
...
You can install the Power Platform CLI in three ways. You can use multiple installation methods on the same computer.

|Method|OS Support|Description|
|---------|---------|---------|
|[Install the Visual Studio Code extension](../howto/install-vs-code-extension.md)|Windows, Linux, macOS|Enables use of commands within a PowerShell terminal within Visual Studio Code on Windows 10, Windows 11, Linux, and macOS.<br /><br />When you install by using only this method, PAC CLI is available by default only within a Visual Studio Code terminal unless you [enable PAC CLI in Command Prompt (CMD) and PowerShell terminals for Windows](../howto/install-vs-code-extension.md#enable-pac-cli-in-command-prompt-cmd-and-powershell-terminals-for-windows).|
...
|[Install with Windows MSI](../howto/install-cli-msi.md)|Windows only|Enables use of commands within a PowerShell terminal within Visual Studio Code on Windows only. You can [manage installed versions](../howto/install-cli-msi.md#manage-versions) by using this installation method.|

> [!NOTE]
> The following commands are available only on Windows:
>
...
>
> To use these commands on Windows, install Power Platform CLI by using either (or both) of these installation methods:
>
> - [Visual Studio Code extension](../howto/install-vs-code-extension.md)
> - [Windows MSI](../howto/install-cli-msi.md)
>
> These commands aren't available on Windows if you only install by using the [.NET Tool](../howto/install-cli-net-tool.md).

### Check whether Power Platform CLI is already installed

How you determine whether the Power Platform CLI is installed depends on your operating system.
...
To see if Power Platform CLI is installed in **Linux or macOS**, open the Terminal or Command prompt, type `which pac` at the prompt, and press **Enter**.
...
> [!NOTE]
> By using the Visual Studio Code extension, [you can view and manage authentication profiles](../howto/install-vs-code-extension.md#authentication-profile-management).
...
When you configure it by using the following instructions, you can type just the beginning of a command and then use the <kbd>Tab</kbd> key to complete the input you entered.
