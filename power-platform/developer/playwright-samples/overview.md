...
description: Learn how the framework included in the  Power Platform Playwright samples repository lets you write reliable end-to-end tests for canvas apps, model-driven apps, custom pages, and AI-generated apps using TypeScript and Playwright.
author: deepakkamboj
ms.author: dekamb
ms.topic: overview
ms.date: 04/17/2026
...
:::image type="content" source="media/playwright.png" alt-text="Playwright logo.":::
...
- **Page Object Model:** Pre-built [`ModelDrivenAppPage`](api-reference.md#modeldrivenapppage), [`CanvasAppPage`](api-reference.md#canvasapppage), and `GenUxPage` classes expose high-level methods so your tests read like requirements.
- **Built-in grid and form components:** [`GridComponent`](api-reference.md#gridcomponent) and [`FormComponent`](api-reference.md#formcomponent) handle the complex ag-Grid and form DOM structures without custom selectors.
...
| AI-generated apps (Gen UX) | `GenUxPage` | Apps generated by Copilot in [Power Apps](https://make.powerapps.com) |
