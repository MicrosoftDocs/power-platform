...
Select **Delete** on the command bar to delete the currently selected pipeline in the dropdown list. A will confirmation message appears regarding your intent and knowledge of the consequence.
