...
## Version compatibility
 ...
 As additional update rollups or service updates are applied to Common Data Service, solutions exported from organizations with those updates cannot be imported into organizations which do not have those updates. More information: [Solution concepts](solution-concepts-alm.md).  
