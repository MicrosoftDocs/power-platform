...
> [!IMPORTANT]
>  Except for the sections described in [When to edit the customizations file](/powerapps/developer/model-driven-apps/when-edit-customization-file), manual editing of extracted component files and .zip files is not supported.  
