...
|modelVersion |`1` or `2` to indicate if the site data to be uploaded will use the the standard (1) or [enhanced data model](/power-pages/admin/enhanced-data-model) (2). |
