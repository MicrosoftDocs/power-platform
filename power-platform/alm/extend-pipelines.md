...
| Event | Input parameters  | <div style="width:275px">Output parameters</div> | Comments |
| --- | --- | --- | --- |
...
| Business Event | Input parameters | <div style="width:275px">Output parameters</div>  | Comments |
| --- | --- | --- | ---  |
