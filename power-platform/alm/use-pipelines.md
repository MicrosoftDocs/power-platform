...
1. Select **New Deployment Stage** to insert a new stage, and then enter the details for each of the stages:
   ...
   - **Target Deployment Environment**: This is the target environment that is associated with this stage. It's a lookup to the deployment environment records that were created in the previous step. In this example, two target stages are created (test to prod).
