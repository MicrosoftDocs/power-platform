...
> [!IMPORTANT]
> The SolutionPackager tool is no longer the recommended way to unpack and pack solutions.  The capabilities of the SolutionPackager tool have been incorporated into the [Power Platform CLI](../developer/cli/introduction).  The [`pac solution`](../developer/cli/reference/solution) command has a number of verbs including [`unpack`](../developer/cli/reference/solution#pac-solution-pack), [`pack`](../developer/cli/reference/solution#pac-solution-unpack), [`clone`](../developer/cli/reference/solution#pac-solution-clone), and [`sync`](../developer/cli/reference/solution#pac-solution-sync) that incorporate the same underlying capabilities of the SolutionPackager tool.
