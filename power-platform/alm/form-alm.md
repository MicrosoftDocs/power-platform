...
1. When you further customize the form you created in Step 1 using upgrades, use the same environment where *Solution B* is in an unmanaged state and clone *Solution B* to create the upgrade solution and customize *FormB*. Export the upgrade as a managed solution. This step exports a [diff FormXml](#differential-diff-formxml) for the form.
...
1. Export unmanaged *Solution A* with the changes made in step 5. This step exports a [full FormXml](#full-formxml) for the form.
