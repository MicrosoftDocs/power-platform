...
1. Create a new solution (named *Solution A* in the below diagram) in the development environment, which will be an unmanaged solution and add your new form. Export the solution as managed. This step will export a [full FormXml](#full-formxml) for the form.
...
1. Create a solution (*Solution A* in the below diagram), which will be an unmanaged solution and add your new form. Export the solution as managed. This step will export a [full FormXml](#full-formxml) for the form.
...
1. Create a new solution (*Solution B* in the below diagram), which is an unmanaged solution, and add *FormB*. Export the solution as managed. This step will export a [differential (diff) FormXml](#differential-diff-formxml) for the form.
...
1. Create a solution (*Solution B*), which will be an unmanaged solution and add *FormB*. Export the solution as managed. This step will export a [diff FormXml](#differential-diff-formxml) for the form.
...
1. When you further customize the form you created in Step 1 using upgrades, use the same environment where *Solution B* is in an unmanaged state and clone *Solution B* to create the upgrade solution and customize *FormB*. Export the upgrade as a managed solution. This step will export a [diff FormXml](#differential-diff-formxml) for the form.
...
1. Create a solution (*Solution A* in the below diagram), which will be an unmanaged solution, and add your new form. Export the solution as unmanaged. This step will export a [full FormXml](#full-formxml) for the form.
...
1. Export unmanaged *Solution A* with the changes made in step 5. This step will export a [full FormXml](#full-formxml) for the form.
...
1. Create a solution (*Solution B* in the below diagram), which will be an unmanaged solution, and add *FormB*. Export the solution as unmanaged. This step will export a [diff FormXml](#differential-diff-formxml) for the form.
...
1. Export unmanaged *Solution B* with the changes made in step 5. This step will export a [diff FormXml](#differential-diff-formxml) for the form.
...
1. Export unmanaged *Solution B* with the changes made in step 5. This step will export a diff FormXml for the form.
