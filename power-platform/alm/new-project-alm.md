...
| 4. Store solution source code in DevOps. | You can either use the Dataverse Git integration or create a DevOps pipeline to export your completed unmanaged solution to a Azure DevOps repository.     |  [Dataverse Git integration](git-integration.md) <br /><br /> [Create your first pipeline](/azure/devops/pipelines/create-first-pipeline?view=azure-devops&preserve-view=true)<br /><br />[Build pipeline: Export a solution from development (DEV)](devops-build-tool-tasks.md#build-pipeline-export-solution-from-development)            |
