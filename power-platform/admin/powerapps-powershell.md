...
| Add, read, and delete connectors | Add-ConnectorToBusinessDataGroup <br />Get-PowerAppConnector *(previously Get-Connector)* <br> Remove-PowerAppConnector *(previously Remove-Connector)* <br /> Remove-ConnectorFromBusinessDataGroup |
| Add, read, update, and delete custom connector permissions | Add-CustomConnectorToPolicy<br />Get-PowerAppConnectorRoleAssignment *(previously Get-ConnectorRoleAssignment)* <br> Set-PowerAppConnectorRoleAssignment *(previously Set-ConnectorRoleAssignment)* <br> Remove-PowerAppConnectorRoleAssignment *(previously Remove-ConnectorRoleAssignment)* <br /> Remove-CustomConnectorFromPolicy |
