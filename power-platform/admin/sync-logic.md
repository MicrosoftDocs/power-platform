...
- **Deleted contacts:**    
  - Contacts deleted in Dynamics 365 are deleted in Exchange only if the user who syncs the contact isn't the owner of the contact.
  - Contacts deleted in Exchange are deleted in Dynamics 365 only if the user who syncs the contact is the owner of the contact.
