...
To assist you in determining which audit logs to delete, we have created the [GetAuditStorageDetails Action](/power-apps/developer/data-platform/webapi/reference/getauditstoragedetails?) where you can get audit storage sizes by table.

Use a tool like [Insomnia](/power-apps/developer/data-platform/webapi/insomnia?) to help you retrieve the audit storage information.
