...
For more detailed information about supported phones and tablets, see [Dynamics 365 mobile and tablet device support](/dynamics365/customer-engagement/mobile-app/support-phones-tablets.md).  
  
> [!NOTE]
> - Users who try to view model-driven apps in Dynamics 365 on an unsupported browser may be redirected to a mobile experience. 
...
## Known issues when you run model-driven apps in Dynamics 365 with certain web browsers  
 This section describes the known issues when you run model-driven apps in Dynamics 365 in a web browser.  
