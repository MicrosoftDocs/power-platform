...
A default security role is automatically assigned to these imported users. The **Salesperson** security role is assigned in a Dynamics CRM environment and the **Basic User** security role is assigned in a Power Apps environment.
