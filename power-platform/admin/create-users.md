...
A default security role is automatically assigned to these imported users. The **Salesperson** security role is assigned in an environment with Dynamics 365 Sales app and the **Basic User** security role is assigned in other environments.
