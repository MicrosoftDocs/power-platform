...
5. In the **Entity Type** list, select the record type you want to view.  
   ...
   | ![One-way sync arrow (right) in Dynamics 365 apps](media/one-way-sync-arrow-right.png "One-way sync arrow (right) in Dynamics 365 apps") | Are synced one way from [!INCLUDE[pn_Outlook_short](../includes/pn-outlook-short.md)] to [!INCLUDE [pn-crm-shortest](../includes/pn-crm-shortest.md)] apps |
   |  ![One-way sync arrow (left) in Dynamics 365 apps](media/one-way-sync-arrow-left.png "One-way sync arrow (left) in Dynamics 365 apps")   | Are synced one way from [!INCLUDE [pn-crm-shortest](../includes/pn-crm-shortest.md)] apps to [!INCLUDE[pn_Outlook_short](../includes/pn-outlook-short.md)] |
