...
8. Type the text you want to send in this message. Use the Formatting toolbar to edit the text.  
   ...
   > - There is no spell check built into Dynamics 365 apps. There might be third-party solutions available. For more information, visit [Microsoft Dynamics Solution Finder](https://www.microsoft.com/dynamics365/partners).  
...
9. To insert data fields to display information such as a customer's name or data from a quote, from a Dynamics 365 apps record, select **Insert/Update**, and then in the **Data Field Values** dialog box, select **Add**.  
