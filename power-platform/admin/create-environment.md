...
4. Enter the following, and then select **Save**.
   ...
   |Security group | Select a security group to restrict access to this environment. This field is required.<br><br>If you want open access, you can select **None**.|
