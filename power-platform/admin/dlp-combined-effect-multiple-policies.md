---
title: "Combined effect of multiple data policies  | MicrosoftDocs"
...
As a tenant or environment admin, you can create more than one data policy and apply it to the same environment. At design time and runtime, all policies that are applicable to the environment in which the app or flow resides are evaluated together to decide whether the resource is in compliance or violation of data policies.
