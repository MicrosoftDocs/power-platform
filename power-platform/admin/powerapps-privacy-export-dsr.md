...
* Microsoft Entra Power Platform administrator or Microsoft Entra Dynamics 365 administrator role if you need to search through another user's resources. (Note that Environment Admins only have access to those environments and environment resources for which they have permissions.)
...
1. From the Power Platform admin center, select each environment in your organization. You must be a Microsoft Entra Power Platform administrator or Dynamics 365 administratorto be able to review all environments created within your organization.
...
1. From the Power Platform admin center, select each environment in your organization. You must be a Microsoft Entra Power Platform administrator or Microsoft Entra Dynamics 365 administrator to be able to review all environments created within your organization.
...
1. From the Power Platform admin center, select each environment in your organization. You must be a Microsoft Entra Power Platform administrator or Microsoft Entra Dynamics 365 administrator role to be able to review all environments created within your organization.
