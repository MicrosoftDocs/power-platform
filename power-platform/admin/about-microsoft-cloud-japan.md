...
Model-driven apps in Dynamics 365, such as Dynamics 365 Sales and Customer Service, are now available as a service within the Japan datacenters.  
  
 In addition, model-driven apps in Dynamics 365 are currently available in 130 markets and 44 languages enabling us to sell side-by-side with [!INCLUDE[pn_Office_365](../includes/pn-office-365.md)] in the majority of the markets worldwide. With the inclusion of Japan, our global customers will now be served from datacenters in 5 global regions around the world.  
...
Model-driven apps in Dynamics 365, such as Dynamics 365 Sales and Customer Service, are currently available in 130 markets and 44 languages enabling us to sell side-by-side with Office365 in the majority of the markets around the globe.  
...
### Do existing customers have the choice to keep their service from being moved to the Japan Datacenters?  
 Existing customers will remain in the datacenters where they are currently deployed unless they request to be moved. [!INCLUDE[cc_Microsoft](../includes/cc-microsoft.md)] reserves the right to make a unilateral decision to migrate accounts based on multiple conditions. All new customers purchasing model-driven apps in Dynamics 365, such as Dynamics 365 Sales and Customer Service, in Japan will be provisioned within the Japan datacenter.  
...
### Will model-driven apps in Dynamics 365 be available on Azure Infrastructure as a Service (IaaS) in Japan?  
