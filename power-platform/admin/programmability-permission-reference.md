...
---- | ------------ | -----------
`AiFlows.Ai.Execute` | Execute AI-related operations (like Generate) on AI flow | Lets you execute AI-related operations, like Generate, on AI flows.
`AiFlows.Ai.Read` | AI-related read operations on AI flow | Lets you perform AI-related read operations on AI flows.
...
`AiFlows.Runs.Execute` | Perform actions on AI flow run | Lets you perform actions on AI flow runs.
...
`AiTools.Prompt.Invoke` | Invoke AI Prompts | Lets you invoke AI prompts.
`AiTools.Prompt.Read` | Read AI Prompts | Lets you read AI prompts.
`AiTools.Prompt.Write` | Read and Write AI Prompts | Lets you read and write AI prompts.
`Analytics.AdvisorActions.Execute` | Analytics.AdvisorActions.Execute | Lets you execute advisor actions.
`Analytics.AdvisorRecommendations.Read` | Analytics.AdvisorRecommendations.Read | Lets you read advisor recommendations.
...
`Authorization.RoleAssignments.Write` | Power Platform role assignment writer | Lets you assign Power Platform role assignments.
...
`CopilotStudio.Copilots.Invoke` | Allows Invoking Copilots | Lets you interact with authenticated copilots hosted by Copilot Studio.
...
`EnvironmentManagement.Groups.ReadWrite` | Read and Write Environment Groups | Lets you read and write environment groups.
...
`Licensing.Allocations.ReadWrite` | Read and Write Currency Allocations | Lets you read and write currency allocations.
