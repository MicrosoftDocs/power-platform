...
1. **Allocate**: assign the purchased add-ons to an environment.
1. **Consume**: once allocated, consume the capacity add-ons.
...
1. In the **Licensing** pane, select **Capacity add-ons**.
1. On the **Capacity** page, select the **Summary** tab.
...
1. Sign in to the [Power Platform admin center](https://admin.powerplatform.microsoft.com/).
1. In the title bar, select the **Settings** icon.
1. Select **Power Platform settings**.
1. On the **Tenant settings** page, select **Add-on capacity assignments**, and then select **Only specific admins**.
