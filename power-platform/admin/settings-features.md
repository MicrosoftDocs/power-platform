...
| **Canvas apps in Dataverse by default**  | Default: Off. Set to **On** to add all newly created canvas apps to the default environment solution.  More information: [Add canvas apps to solution by default](/power-apps/maker/canvas-apps/add-app-solution-default) |
