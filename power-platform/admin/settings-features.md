...
| Advanced Settings | Open the Advanced Settings page to enable MCP clients not in Copilot Studio, such as Claude. Learn more: [Configure and manage the Dataverse MCP server for an environment](/power-apps/maker/data-platform/data-platform-mcp-disable#configure-and-manage-the-dataverse-mcp-server-for-an-environment) | Clients not in Copilot Studio are disabled. |
