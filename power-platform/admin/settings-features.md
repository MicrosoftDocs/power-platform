...
> | **Create new canvas apps as Dataverse solutions (preview)**  | Default: Off. Set to **On** to add all newly created canvas apps to the default environment solution.  More information: [Add canvasand cloud flows to solution by default (preview)](/power-apps/maker/canvas-apps/add-app-solution-default) |
