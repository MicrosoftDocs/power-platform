...
> |End users can add and join Teams meeting from appointments in model-driven apps.  | Default: Off. Turn **On**, to allow users create and join Teams meeting from an appontment. For more information, see [Create and join a Teams meeting from an appointment](/powerapps/user/join-teams-meeting-from-appointments.md).  |
> |**Search**||  
