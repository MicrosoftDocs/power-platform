...
| Setting | Description | Default value |
|---------|-------------|---------------|
| Allow users to access production-ready preview Process Mining features. | If **On**, Power Automate Process Mining users in this environment have access to production-ready preview features in Process Mining. | On |
...
| Setting | Description | Default value |
|---------|-------------|---------------|
| Environment settings behavior | When **On**, a system administrator or customizer is directed to the Environment Settings app.| On |
## Recycle Bin (preview)
