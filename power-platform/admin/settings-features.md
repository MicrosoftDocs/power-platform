...
## Enhanced desktop flow schema settings
| Setting | Description | Default value |
|---------|-------------|---------------|
|         |             |               |

## Grids and views settings
| Setting | Description | Default value |
|---------|-------------|---------------|
...
## Create new canvas apps as Dataverse solutions (preview) settings
| Setting | Description | Default value |
|---------|-------------|---------------|
...
## Long term data retention in Dataverse (preview) settings
| Setting | Description | Default value |
|---------|-------------|---------------|
...
## Finance and Operations in Dataverse settings
| Setting | Description | Default value |
|---------|-------------|---------------|
...
## Map and address services settings
| Setting | Description | Default value |
|---------|-------------|---------------|
...
## Power Apps component framework for canvas apps settings
| Setting | Description | Default value |
|---------|-------------|---------------|
...
## Delete disabled users settings
| Setting | Description | Default value |
|---------|-------------|---------------|
...
## Record ownership across business units settings
| Setting | Description | Default value |
|---------|-------------|---------------|
...
## Power Apps ideas for canvas apps settings
| Setting | Description | Default value |
|---------|-------------|---------------|
...
## Power BI components (preview) settings
| Setting | Description | Default value |
|---------|-------------|---------------|
...
> | **Copilot (preview)**  | Default: On. When **On**, enables Copilot to create apps, tables, edit apps, generate formulas, answering how-to questions and AI Builder GPT experiences. More information: [AI Copilot overview ](/power-apps/maker/canvas-apps/ai-overview) |
