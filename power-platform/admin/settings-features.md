...
| Setting | Description | Default value |
|---------|-------------|---------------|
| Displays record summaries generated by Copilot on model-driven app main forms. | If **On**, record summaries generated by Copilot are displayed to users for rows (records) on model-driven app main forms. More information: [Configure a row summary for a model-driven app main form](/power-apps/maker/data-platform/configure-form-row-summary) | Off |
