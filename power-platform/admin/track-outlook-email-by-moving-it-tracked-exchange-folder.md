...
1. In the web app, on the nav bar, click **Options** ![Options button for Dynamics 365 apps](media/optionsbutton.png "Options button for Dynamics 365 apps").  
...
### See also  
 [Frequently asked questions about synchronizing records between Microsoft Dynamics 365 apps and Microsoft Outlook](frequently-asked-questions-synchronizing-records-dynamics-365-and-outlook.md)<br />
