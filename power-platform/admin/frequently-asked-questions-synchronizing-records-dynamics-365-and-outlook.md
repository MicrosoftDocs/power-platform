---
title: "Frequently asked questions about synchronizing records between Dynamics 365 apps and Outlook  | MicrosoftDocs"
description: Frequently asked questions about synchronizing records between Dynamics 365 apps and Outlook 
author: jimholtz
manager: kvivek
...
search.app: 
  ...
  - Powerplatform
---
# Frequently asked questions about synchronizing records between Dynamics 365 apps and Microsoft Outlook

## What's the best way to use Outlook and Microsoft Dynamics 365 apps together?  
 There are three ways to use model-driven apps in Dynamics 365, such as Dynamics 365 Sales and Customer Service, and [!INCLUDE[pn_Outlook_short](../includes/pn-outlook-short.md)] together:  
...
### See also 
 [Integrate your email system with Dynamics 365 apps](../admin/integrate-synchronize-your-email-system.md)   
 ...
 [Set personal options that affect tracking and synchronization between Dynamics 365 apps and Outlook or Exchange](set-personal-options-affect-tracking-synchronization-between-dynamics-365-outlook-exchange.md)
