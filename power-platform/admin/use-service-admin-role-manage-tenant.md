...
To help you administer Dynamics 365, you can assign users to manage Dynamics 365 at the tenant level without having to assign the more powerful [!INCLUDE[pn_Office_365](../includes/pn-office-365.md)] global admin privileges.  
  
 Users with the Dynamics 365 service admin role can:  
  
- Sign in to and manage  multiple Dynamics 365 environments. If an environment uses a security group, a service administrator would need to be added to the security group in order to manage that environment.  
