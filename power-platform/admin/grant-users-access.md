...
> Before you start adding information to Dynamics 365 apps, we recommend that you turn off or disable your browser’s pop-up blocker. Pop-up blockers can block data-entry dialog boxes in Dynamics 365 apps. 
 ...
 You might have [!INCLUDE [pn-crm-shortest](../includes/pn-crm-shortest.md)] apps data located in other systems. In your planning phase, you considered how you’ll import this data. Before you invite users into Dynamics 365 apps, ensure that you have completed the data migration process. [!INCLUDE[proc_more_information](../includes/proc-more-information.md)] [Import data (all record types)](../admin/import-data-all-record-types.md).  
