...
> - For an OnlineDev unified developer environment (UDE) for finance and operations apps, package deployment can be used while an environment is in administration mode. For details, see [Manage administration mode in a unified developer environment](../developer/unified-experience/finance-operations-deploy-admin-mode.md).
