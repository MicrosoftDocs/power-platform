...
[!TIP] In addition to the settings mentioned below, there are more settings available to control email behavior. For more information, see [OrgDBOrgSettings for server-side synchronization](OrgDbOrgSettings.md).
