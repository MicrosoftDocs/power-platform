...
|---------|---------|---------|
|Trial (standard)     |  End user or admin      |  Power Platform admin center. See [Creating a trial environment in the Power Platform admin center](#creating-a-trial-environment-in-the-power-platform-admin-center)       |
