...
Using the Power Platform admin center, you can create three types of Common Data Service environments: sandbox, production, or trial. A trial environment is useful for trying out model-driven apps in Dynamics 365, such as Dynamics 365 Sales and Customer Service, at no cost. Trial environments expire after 30 days.
