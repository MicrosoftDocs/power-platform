...
> [!WARNING]
> Option 1 and 3 use IP Binding which doesn't work correctly if customers have IP Pools, Reverse Proxy, or Not enabled gateways used within their networks. This results in a user's IP address changing too frequently for a requester to reliably have the same IP between the read/write operations of the SAS. Options 2 and 4 work as intended.
