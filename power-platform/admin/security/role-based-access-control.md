...
RBAC assignments can be managed through Power Platform APIs and SDKs. These APIs and SDKs provide programmatic options for managing roles, suitable for automation and integration in larger organizations. For a step-by-step walkthrough, see [Tutorial: Assign role-based access control roles to service principals](../programmability-tutorial-rbac-role-assignment.md).
...
For detailed reference on permissions, roles, and integration, see [Power Platform API reference](/rest/api/power-platform/). To learn how to assign these roles programmatically, see [Tutorial: Assign role-based access control roles to service principals](../programmability-tutorial-rbac-role-assignment.md).
