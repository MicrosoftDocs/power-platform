...
- **Customer Managed Key**:This feature allows customers to manage the key that encrypts Power Platform and Dynamics 365 data, preventing outside access to customer data and meeting data protection requirements. [Learn more](https://learn.microsoft.com/en-us/power-platform/admin/customer-managed-key)
