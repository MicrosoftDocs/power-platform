...
|**Tracking token preview**|xxxxxxx|
|**Prefix**| xxxx|
...
|**Use smart matching**|Default: Off.|
...
|**Tracking items**| |
|**Use Outlook categories to track Outlook items**|Default: Not selected. Off.|
|**Allow auto-tracking from sent items**|Default: Not selected. Off.|
