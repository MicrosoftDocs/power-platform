...
> - If an environment is [virtual network enabled] (https://learn.microsoft.com/en-us/power-platform/admin/vnet-support-overview), you can only copy to an environment in the same enterprise policy.
