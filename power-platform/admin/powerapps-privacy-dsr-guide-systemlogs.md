...
| Who has access to the Data Log Export tool to submit access requests for system-generated logs? |  Global admin will have access to the privacy Log Manager tool.
