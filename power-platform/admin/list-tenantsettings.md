...
|powerPlatform.licensing.disableUseOfUnassignedAIBuilderCredits| Boolean | Disable the use unallocated AI Builder credits in environments without allocated credits. Default is false. (disable=false, so use of unassigned credits is enabled) |
