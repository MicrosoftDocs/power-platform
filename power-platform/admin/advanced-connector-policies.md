...
- **Missing connectors from UI**: It could be that you are not able to find the connector in the UI. For that reason you would need to use Powershell to see the current state of all connectors.
