...
- **Version**: The gateway software version installed on the machine. Version numbers shown here are cached. After you update your gateway version on the gateway machine, it usually takes 5-6 days to reflect the changes in Power Platform admin center.
