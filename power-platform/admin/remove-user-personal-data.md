...
Once the user record is deleted from Active Directory, Dynamics 365 apps system admins can remove the user's personal data from all instances.
...
- [Update and delete entities using the Web API](/dynamics365/customer-engagement/developer/webapi/update-delete-entities-using-web-api.md)
- [Use the Entity class for create, update and delete](/dynamics365/customer-engagement/developer/org-service/use-entity-class-create-update-delete.md)
