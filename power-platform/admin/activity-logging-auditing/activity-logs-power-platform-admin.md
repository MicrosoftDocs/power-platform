...
![Screenshot of the Microsoft Purview audit search page showing the Activities - friendly names dropdown. The three deprecated Power Platform DLP activity names — Created DLP Policy, Updated DLP Policy, and Deleted DLP Policy — are highlighted in a red box.](../media/audit-logs/dlp-deprecated-activities.png)
