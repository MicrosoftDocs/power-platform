...
In this case, the user must either have or belong to a team that has a role assigned which has the required privilege with at least the access level Parent:Child Business Units.
...
- The manager has a security role assigned directly or through a team that have the access level Business Unit or Parent:Child Business Units.
AND
