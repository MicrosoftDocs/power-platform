...
- Copying and restoring data may take more than a day, depending on the size of the data,  especially if you need to copy [audit data](backup-restore-environments#restoring-audit-logs).
