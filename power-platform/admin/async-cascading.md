...
1. Sign in to the **[Power Platform admin center](https://admin.powerplatform.microsoft.com/environments/)**, and then select the environment you want. Select **Settings**, expand **Audit and logs**, and then select **System jobs**.
