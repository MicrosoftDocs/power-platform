...
When users are deleted/disabled in Microsoft Entra or removed from the Microsoft Entra groups, they lose their group membership and won't be able to access the environment when they try to sign in.  
