...
> - Team members are added/removed from group team at run-time when the group member logs into the environment. These addition/removal group member events can be used to trigger plugin operations.
