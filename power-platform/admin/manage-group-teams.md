...
| Owners     | Select this type to include only user type Owners (2 - blank) from the Azure AD group category (1).     |
| Guests     | Select this type to include only user type Guests (2) from the Azure AD group category (1).    |
