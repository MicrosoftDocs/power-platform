...
- **Extended backup retention**: Production managed environments can extend their backup retention from seven to 28 days. Learn more in [Back up and restore environments](../backup-restore-environments.md).
