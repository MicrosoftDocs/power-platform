...
- Tagging is not yet working.
- Deleting a business policy does not delete the corresponding Power Platform Account resource.
- Power Platform admin center downloadable usage reports provide data for only the last 30-day period.
- Billing is only for the first 30 days of a month.
