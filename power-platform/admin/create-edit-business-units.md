...
1. On the **Business Units** page, click **New business unit** in the command bar.
...
In the **Create new business unit** panel:
...
1. On the **Details** pane, click **Edit**.
1. In the **Edit busines unit** panel, make the necessary changes, then click **Save** to apply them. 
...
1. In the command bar, click **Change business unit**.
...
- Select the desired business unit, then click **Reassign business unit records** in the command bar.

-**OR**-

- Select the desired business unit then click it. In the business unit **Details** page, select **Reassign business unit records** in the command bar.
