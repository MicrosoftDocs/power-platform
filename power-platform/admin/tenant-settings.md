...
|Hosted browser in computer use | Hosted browser in [computer use](/microsoft-copilot-studio/computer-use) allows users to automate web tasks and access built-in Windows apps using a Microsoft-hosted virtual machine powered by Windows 365. This setup requires no infrastructure and the virtual machine is not customer Entra-joined.|
