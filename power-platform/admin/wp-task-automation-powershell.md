...
|---------|---------|
|PowerApps cmdlets <br/>https://docs.microsoft.com/en-us/powerapps/administrator/powerapps-powershell     |Designed for app makers and administrators to automate tasks with environments and associated apps, flows and connectors. <br/> **Note**: These cmdlets are currently in preview.        |
