...
|     Deployment base tracking number     |                                                                                                                                                                                 Configurable from 0-2,147,483,647. Default value is 0. Can be used as an identifier for a specific instance, organization, or deployment of [!INCLUDE[pn_microsoftcrm](../includes/pn-dynamics-crm.md)] apps .                                                                                                                                                                                  |
