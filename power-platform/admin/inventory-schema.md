...
Copilot Studio agents have a rich set of properties beyond the shared fields, including core, identity, and configuration properties. For the full schema, see [Copilot Studio agents inventory schema](inventory-schema-copilot-studio-agents.md).
