...
Power Platform requests generated when a user runs an app created in Cowork or Microsoft Copilot Studio count toward the user's applicable Power Platform request limit. For users with a Power Apps Premium license, these requests are included in the limit of 40,000 requests per user per 24-hour period. If a user exceeds the included capacity, subsequent app usage is metered and charged through Copilot Credits according to the applicable licensing terms. Integrated services, such as Work IQ, are metered and charged separately under their respective licensing terms.
