...
7. Agree to the terms and conditions and select the **Install** button to start the installation. Wait for the installation to finish&mdash;the **Status** column switches from **Installing** to **Installed**&mdash;before proceeding to the next step.
