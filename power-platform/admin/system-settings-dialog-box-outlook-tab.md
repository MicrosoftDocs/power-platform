...
|                                                       Send pending Dynamics 365 apps email every                                                        |                                         Default: 10 minutes. Sends pending [!INCLUDE[pn_microsoftcrm](../includes/pn-dynamics-crm.md)] apps email on the specified interval.                                         |
