...
Dataverse auditing supports the deletion of a single records entire audit history. This is useful when replying to a GDPR request of a customer asking for the deletion of their data. 
