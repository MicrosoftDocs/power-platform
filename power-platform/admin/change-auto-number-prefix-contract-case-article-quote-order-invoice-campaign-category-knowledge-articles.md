...
1. Select **Settings** > **Data management** > **Auto numbering**.  

1.  In the **Set Auto-Numbering** dialog box, select the record type that you want to change.  
  
1.  In the **Prefix** box, enter up to three characters, symbols, or numbers.  
...
1.  In the **Number** box, enter the starting number.  
