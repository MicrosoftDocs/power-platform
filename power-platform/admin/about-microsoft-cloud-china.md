...
[Download Azure IP Ranges and Service Tags – China Cloud from Official Microsoft Download Center](microsoft.com)

Within the JSON file linked through Download Center, above, Business Applications Engineering suggests a focused review on defined IP filtering related to the following tags:
...
#### We have extended our solution to leverage our own Azure resources, such as API Hubs, Logic Apps, Azure Storage, etc.   Do we need to coordinate this transition and also move those workloads and resources to China 3 datacenters?
...
#### If our Azure resources are operating in China 2 datacenters, but our Dataverse and related Business Applications are migrated to China 3, will this introduce measurable latency in our application’s performance? 
As these datacenters are connected through Microsoft Azure’s network backbone, we do not expect there to be a measurable effect on communication latency.  Customers can measure latency expectations through tools such as the Azure Speed Test, available here: https://www.azurespeed.com/Azure/Latency 
...
#### Will we expect to experience downtime?
