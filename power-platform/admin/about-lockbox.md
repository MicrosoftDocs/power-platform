...
> [!NOTE]
> Currently, the applications and services where lockbox policy is going to be enforced once enabled are Power Apps (including AI Builder, Power Apps portals), Power Automate, Power Virtual Agents, Dataverse, Customer Insights, and Marketing.
