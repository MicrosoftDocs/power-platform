...
|-------------------------------------------------------------------------------------|-----------------------|
| Enable or disable document management    |  **Security roles**:  System Administrator or System Customizer<br /><br /> **Privileges**:  Read, Write on all record types that are customizable.<br /><br /> **[!INCLUDE[pn_SharePoint_short](../includes/pn-sharepoint-short.md)] site permission**s: Create, Read, Write, Append, Append To          |
