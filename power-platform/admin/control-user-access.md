...
- If an environment doesn't have an associated security group, all users with a Dataverse license (customer engagement apps— such as Dynamics 365 Sales, Dynamics 365 Customer Service, Dynamics 365 Field Service, Dynamics 365 Marketing, and Dynamics 365 Project Service Automation—Power Automate, Power Apps, and others) will be added and enabled in the environment.  
