...
1. In Dynamics 365 apps, click **Settings** > **Email Configuration**.  
...
Once you’ve enabled folder-level tracking, users will need to configure folder-tracking rules in Dynamics 365 apps with Settings (![Gear button](../admin/media/selection-rule-gear.png "Gear button")) > **Options** > **Email** > **Configure Folder Tracking Rules**.  
