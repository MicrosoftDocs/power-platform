...
| [style-src](https://developer.mozilla.org/docs/Web/HTTP/Headers/Content-Security-Policy/style-src) | `'self' 'unsafe-inline' blob: <platform>` | `'self' 'unsafe-inline' blob: <platform>` | Yes |
