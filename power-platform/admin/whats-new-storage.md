...
|Date  |Description  |
|---------|---------|
| September 2021 | We're providing free storage capacity for the default environment: 3GB Dataverse Database Capacity, 3GB Dataverse File Capacity, and 1GB Dataverse Log Capacity. |
