...
| April 2025 | We are making internal adjustments to how Web Resources are stored in a Dataverse organiztion. Web Resources continue to be reported as file store, however, customers may see the size of *WebResourceBase* flucuate as storage is transitioned internally. Dataverse doesn't expect storage to signifigantly increase for  *WebResourceBase*, but may temporarily drop as files are transitioned. |
