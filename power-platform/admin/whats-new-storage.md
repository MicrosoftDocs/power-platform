...
| April 2024 | We are making internal adjustments to how Web Resources are stored in a Dataverse Organiztion. Web Resources will continue to be reported as file store, however, Customers may see the size of *WebResourceBase* flucuate as storage is transitioned internally. Dataverse does not expect storage to signifigantly increase for  *WebResourceBase* but may temporarily drop as files are transitioned. |
