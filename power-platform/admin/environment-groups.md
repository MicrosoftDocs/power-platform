...
:::image type="content" source="media/environment-group-strategy-sharpened.png" alt-text="Diagram depicting one strategy for using environment groups and aligning it to your existing orgnizational structure.":::
