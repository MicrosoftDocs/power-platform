...
### Create a trusted security token issuer for Microsoft Entra ID on SharePoint  
 ...
 For detailed information about these [!INCLUDE[pn_PowerShell_short](../includes/pn-powershell-short.md)] commands, go to [Use Windows PowerShell cmdlets to administer security in SharePoint 2016](/archive/technet-wiki/34284.sharepoint-2016-list-of-powershell-cmdlets).  
