...
- Every user running a Power Automate cloud flow in a managed environment must have a standalone Power Automate per user license, or the flow must have a Power Automate per flow license or a Dynamics 365 license with premium Power Automate usage rights. Power Automate cloud flows that are triggered within apps/in context of apps or chat bots are covered by the respective Power Apps/Power Virtual Agents standalone licenses.
