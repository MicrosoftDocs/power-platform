...
- Every user running an app in a managed environment must have a Power Apps per user or per app license or a D365 license that give premium Power Apps usage rights. 
- Every user running a Power Automate flow in a managed environment must have a standalone Power Automate per user license, or the flow must have a Power Automate per flow license or a D365 license with premium Power Automate usage rights. 
