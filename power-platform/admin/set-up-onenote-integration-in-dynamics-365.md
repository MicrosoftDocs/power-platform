...
[!INCLUDE[proc-more-information](../includes/proc-more-information.md)]  [Use OneNote in Dynamics 365 apps](../basics/use-onenote.md)
...
### See also  
 [Use OneNote in Dynamics 365 apps](../basics/use-onenote.md)   
