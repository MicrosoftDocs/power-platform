...
1. Review the terms of use and select the **Move data across regions** checkbox.
    ...
    When you use Copilots and generative AI features&mdash;and the **Move data across regions** checkbox is selected&mdash;your inputs (prompts) and outputs (results) might move outside of your region to the location where the generative AI feature is hosted, as described in the preceding table. For core online services, allowing data movement across regions with toggle doesn't impact the commitments made in the Product Terms regarding storage of customer data at rest. Learn more in [Regions where data is processed for Copilots and generative AI features](#regions-where-data-is-processed-for-copilots-and-generative-ai-features).
