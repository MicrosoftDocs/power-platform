...
>
> Please note that only emails that match the Dynamics 365 direction code will be automatically categorized when the system setting "[Track emails sent between Dynamics 365 users as two activities](settings-email-tracking.md)" is enabled. 
>
