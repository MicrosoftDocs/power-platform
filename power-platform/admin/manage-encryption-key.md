...
- Copilots and generative AI features in [Microsoft Power Platform and Microsoft Dynamics 365](https://learn.microsoft.com/power-platform/admin/geographical-availability-copilot) 
- Dataverse search
- Elastic tables
- Mobile Offline
