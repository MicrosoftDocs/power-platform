...
> [!IMPORTANT]
> Self-managed database encryption keys are only available for customers who have more than 1000 Power Apps per user licenses and/or Dynamics 365 Enterprise licenses (or a combination of these) in single tenant and who have opted in to the feature.  To opt in to this program, submit a [support request](./support-overview.md#using-support).
>
