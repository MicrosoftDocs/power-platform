...
### What are the future geographic expansion plans for model-driven apps in Dynamics 365?  
 Geographic expansion of model-driven apps in Dynamics 365 is a high priority and we’re constantly evaluating market needs. While we have no additional information or specifics on future plans to announce at this time, we will update if and when we have something to share.  
...
### Will Microsoft Dynamics Marketing, Social Engagement, and Parature be available in the Australia datacenters?  
 These services will be available for purchase in the local market but will be delivered outside of the Australia Datacenters at this time. Note: model-driven apps in Dynamics 365 leverages [!INCLUDE[pn_microsoft_azure_active_directory](../includes/pn-microsoft-azure-active-directory.md)] and Multi-Factor Authentication, which don’t offer a region choice to customers.  
  
### Will model-driven apps in Dynamics 365 apps be available on Azure Infrastructure as a Service (IaaS) in Australia?  
