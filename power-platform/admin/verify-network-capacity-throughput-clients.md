...
The primary characteristics of a network that affect the performance of Dynamics 365 apps clients, such as the web application or [!INCLUDE[pn_crm_for_outlook_short](../includes/pn-crm-for-outlook-short.md)], are *bandwidth* and *latency*.  
...
One of the main causes of poor performance of Dynamics 365 apps clients is the latency of the network over which the clients connect to the Dynamics 365 apps organization. Lower latencies (measured in milliseconds) generally provide better levels of performance.  
...
## How to check latency  
 Dynamics 365 apps includes a basic diagnostic tool that analyzes the client-to-organization connectivity and produces a report. To run the Dynamics 365 apps Diagnostics tool, follow these steps.  
  
1. On the user’s computer or device, start a web browser, and sign in to a Dynamics 365 apps organization.  
