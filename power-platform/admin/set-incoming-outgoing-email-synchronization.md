...
You have several options for synchronizing email messages with Dynamics 365 apps. Use the following information to deploy the best option for your company.  
...
## Incoming email messaging options  
 The available incoming email configurations that you can use when a user or a queue receives Dynamics 365 apps email messages are as follows:  
  
- **None**. Use this option for users or queues that do not use Dynamics 365 apps to track received email messages.  
