...
Model-driven apps in Dynamics 365, such as Dynamics 365 Sales and Customer Service, generate alerts if errors occur while email is being processed. An error can be classified based on the nature of the error and on whether the error is for an email, a mailbox, or an email server profile.  
