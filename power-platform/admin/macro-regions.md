...
A macro region represents the data residency boundary that aligns with data residency laws for a given geography. This article lists the regions (georaphies/countries) available in a specific macro region.
...
- New tenants that don't meet [geo-selection eligibility](#geo-selection-eligibility-criteria) criteria, a macro region and don't choose a region (geo / country) during environment creation. New is associated with creation of first Power Platform environment for the tenant.  
...
|3  | European Union (EU)  and European Free Trade Association (EFTA)       |France, Germany, Norway, Sweden, Switzerland, Poland, Italy, Ireland, Netherlands      | Your data resides within European Union and EFTA member states which are European Union Data Boundary (EUDB) regions. | 
