...
> [!NOTE]
> Your admin must first allow acess in the [Microsoft 365 admin center](https://learn.microsoft.com/en-us/copilot/microsoft-365/connect-to-ai-models). Once allowed there, you can access these settings in the Power Platform admin center.
