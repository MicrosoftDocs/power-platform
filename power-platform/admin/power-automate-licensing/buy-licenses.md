...
[!TIP]
To learn more about how to allocate the per flow license to an environment in the Power Platform admin center, please see [capacity add-ons for Power Apps and Power Automate](../capacity-add-on.md) section.
