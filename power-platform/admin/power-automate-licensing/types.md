...
Power Automate hosted process plan | Licensed per bot, Power Automate Hosted Process is a super-set of the Power Automate Process, providing the same functionality but with the addition of a Microsoft hosted machine capacity that can be used for hosted machine or hosted machine group, enabling RPA with zero infrastrcuture. [Purchase it](https://powerautomate.microsoft.com/pricing) 
