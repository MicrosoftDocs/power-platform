...
1. In the **Select license type** section, the required license is preselected based on your usage. For example, if you use RPA (robotic process automation) in any of your flows, **[Power Automate Premium plan](../types.md#user-licenses)** is selected by default.
