...
| Using a [!INCLUDE[pn_ms_Word_short](../includes/pn-ms-word-short.md)] document generated in Dynamics 365 apps |                           2010, 2013, 2016                            |

> [!NOTE]
> Macro-enabled Word documents (.docm) are not supported.

 Follow the steps in this topic to successfully create and use [!INCLUDE[pn_ms_Word_short](../includes/pn-ms-word-short.md)] templates in Dynamics 365 apps.  
...
### Where you can create a template  
 There are three places in Dynamics 365 apps where you can create a [!INCLUDE[pn_ms_Word_short](../includes/pn-ms-word-short.md)] template:  
...
## Step 2: Enable the Developer tab  
 ...
 To see and add Dynamics 365 apps XML data, you need to enable the [!INCLUDE[pn_ms_Word_short](../includes/pn-ms-word-short.md)] Developer tab.  
...
## Important! A known issue and how to avoid it  
 There’s a known issue with Dynamics 365 apps-generated [!INCLUDE[pn_ms_Word_short](../includes/pn-ms-word-short.md)] templates and [!INCLUDE[pn_MS_Word_Full](../includes/pn-ms-word-full.md)]. In the next section, you’ll be adding XML content control fields to the [!INCLUDE[pn_ms_Word_short](../includes/pn-ms-word-short.md)] template.  
...
1. You use the XML Mapping Pane to add Dynamics 365 apps entity fields to your [!INCLUDE[pn_ms_Word_short](../includes/pn-ms-word-short.md)] template. Be sure to only add fields as **Plain Text** or **Picture**.  
...
## Step 3: Define the [!INCLUDE[pn_ms_Word_short](../includes/pn-ms-word-short.md)] template  
 Use the XML Mapping Pane to define the [!INCLUDE[pn_ms_Word_short](../includes/pn-ms-word-short.md)] template with Dynamics 365 apps entity fields.  
...
2. Select the Dynamics 365 apps XML schema. It will begin with “urn:microsoft-crm/document-template/”.  
...
3. Expand the Dynamics 365 apps entity, right-click the entity field, and then click **Insert Content Control** > **Plain Text**.  

   ![Insert the Dynamics 365 apps field as Plain Text](../admin/media/word-template-insertfield-plain-text.png "Insert the Dynamics 365 apps field as Plain Text")  

   The Dynamics 365 apps entity field is added to the [!INCLUDE[pn_ms_Word_short](../includes/pn-ms-word-short.md)] template.  
...
3. In the XML Mapping Pane, right-click the relationship containing the content control fields, and then click **Repeating**.  
   ...
   When you use the [!INCLUDE[pn_ms_Word_short](../includes/pn-ms-word-short.md)] template in Dynamics 365 apps to create a document, the table will populate with multiple rows of data.  

   When the template has the fields and formatting you want, save it and upload it into Dynamics 365 apps.  

<a name="BKMK_Upload"></a>  

## Step 4: Upload the Word template back into Dynamics 365 apps 
When you have your [!INCLUDE[pn_ms_Word_short](../includes/pn-ms-word-short.md)] template built the way you want, save it so you can upload it into Dynamics 365 apps.  
 ...
 Dynamics 365 administrators can use the Settings page to upload the [!INCLUDE[pn_ms_Word_short](../includes/pn-ms-word-short.md)] template into Dynamics 365 apps. A template uploaded in Settings is available to all users in your Dynamics 365 apps organization.  

### For admins: Upload the Word template into Dynamics 365 apps 

1. In Dynamics 365 apps, go to **Settings** > **Templates** > **Document Templates**.  
...
1. In Dynamics 365 apps, open a page with a list of records, for example, the list of customer accounts in Sales.  
...
2. Click **More** (**…**) **> Word Templates**, and then under **Word Templates** select the template you created.  
   ...
   2. You need to refresh Dynamics 365 apps to see the template. Either refresh your browser or close and reopen Dynamics 365 apps.  

   After you select your [!INCLUDE[pn_ms_Word_short](../includes/pn-ms-word-short.md)] template, Dynamics 365 apps creates a [!INCLUDE[pn_ms_Word_short](../includes/pn-ms-word-short.md)] document from the record you selected.  
...
### Lists in created documents are not in the same order as records  
 Lists of records created from a custom template may not appear in the same order in [!INCLUDE[pn_ms_Word_short](../includes/pn-ms-word-short.md)] documents as the order in Dynamics 365 apps. Records are listed in the order of the time and date they were created.  
