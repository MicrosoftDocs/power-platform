...
| Dynamics 365 Service Scheduling | Once you opt-in to early access: <br /> 1. Sign-in to the Power Platform admin center as tenant admin <br />2. Select**Dynamics 365 Service Scheduling** <br /> 3. Select **Install** and follow the steps. |
