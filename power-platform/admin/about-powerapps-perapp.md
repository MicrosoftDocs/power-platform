...
The Power Apps per app plan assignment report is available in [license consumption reports in Power Platform admin center](https://learn.microsoft.com/power-platform/admin/view-license-consumption-issues). 
