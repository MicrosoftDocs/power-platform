...
> - [Power Apps for Windows](https://www.microsoft.com/p/power-apps/9nblggh5z8f3?activetab=pivot:overviewtab&preserve-view=true) isn't supported if you have the Power Apps per app plan.
