...
| Copilot Studio | A billable copilot studio message is a request or message sent to the copilot triggering an action and/or response. Any Agent or Custom copilot usage will be billed via Copilot studio message meter .| $0.01 per message  |
