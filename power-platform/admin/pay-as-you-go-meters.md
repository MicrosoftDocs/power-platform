...
| Windows 365 for Agents | Billable computer use execution (node) using Windows 365 for Agents Cloud PCs. Refer to using [Cloud PC pool for computer use runs (preview)](/microsoft-copilot-studio/use-cloud-pc-pool) for more information.| Learn more in [Windows 365 for Agents (preview)](https://aka.ms/W365AMSLearn) |
