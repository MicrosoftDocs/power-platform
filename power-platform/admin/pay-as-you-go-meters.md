...
| Copilot Studio | The Copilot Studio pay-as-you-go meter counts the total number of Copilot Credits consumed by agents. <br/>“Copilot Credits” are a measure of the time and effort required for your agent to retrieve information and respond to your prompts and any actions that the agent takes, based on custom triggers and skills. The number of Copilot Credits decremented for each response or action is dependent on the complexity of the task completed by the agent.<br/>For the most complete and up-to-date Copilot Studio licensing and billing information, refer to the [Microsoft Copilot Studio Licensing Guide](https://go.microsoft.com/fwlink/?linkid=2320995)| $0.01 per credit  |
