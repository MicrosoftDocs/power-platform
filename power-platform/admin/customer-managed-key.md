...
> [!NOTE]
> The result link and other data produced by solution checker enforcement during a solution check continues to be encrypted with a Microsoft-managed key.
