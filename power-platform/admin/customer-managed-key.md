...
> [!NOTE]
> The result link and issue summary produced by solution checker enforcement during a solution check continues to be encrypted with a Microsoft-managed key.
