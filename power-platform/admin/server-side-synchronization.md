...
> [!NOTE]
> Only mailboxes can be configured for synchronization. Using alias, distribution lists etc. is not supported because the synchronization is asynchronous and these types of resources don't store the emails.
