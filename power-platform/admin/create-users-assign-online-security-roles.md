...
A default security role is automatically assigned to these imported users. The **Salesperson** security role is assigned in an environment and the **Dataverse User** security role is assigned in a Power Apps environment.
