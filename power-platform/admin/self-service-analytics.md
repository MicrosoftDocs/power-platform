...
1. Sign in to the Power Platform admin center as a Microsoft Entra Global Admin, select **Export to Azure Data Lake**, and then select **Power Apps** or **Cloud flows**.  The Global Admin user must have specific roles described in the section First-time setup of data export below.
