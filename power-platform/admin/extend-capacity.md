...
# Extend Dataverse capacity for 45 days

You have options when you're running low on storage capacity. You can [free up storage](free-storage-space.md), [delete unwanted environments](delete-environment.md), or extend an extra 25% capacity to your tenant for 45 days. 
