...
| SSSUpdatePastMeetingsInNonDraftMode | false | Allows updates for past meetings in Dynamics 365 to propagate to Exchange when critical properties are changed such as start, end, subject, body, attendees, location.. <br>**Note**: If this setting is enabled, it may send out meeting requests for past meetings. |
