...
- **Teams environments**: Currently, it's not possible to filter agents created in Microsoft Teams environments. These agents will still appear in the inventory list; however, the Environment Type column will be blank. This issue will be resolved shortly.
