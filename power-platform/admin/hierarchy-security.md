...
> [!div class="mx-imgBorder"] 
> ![](../admin/media/sales-vp-access.png "Read access for VP of Sales in Dynamics 365 for Customer Engagement")
...
> [!div class="mx-imgBorder"] 
> ![](../admin/media/appointment-fields-customization.png "Sales person user record in Dynamics 365 for Customer Engagement")
...
1. Select an environment and go to **Settings** > **Users + Permissions** > **Positions**.
   ...
   > [!div class="mx-imgBorder"] 
   > ![](../admin/media/active-positions.png "Active positions in Hierarchy Security in Dynamics 365 for Customer Engagement")
  
   The example of the enabled users with their corresponding positions is shown below:  
  
   > [!div class="mx-imgBorder"] 
   > ![](../admin/media/hierachy-security-enabled-users.png "Enabled users with assigned positions in Dynamics 365 for Customer Engagement")
...
### See also  
 [Security concepts for Microsoft Dynamics 365 for Customer Engagement](https://docs.microsoft.com/en-us/dynamics365/customer-engagement/admin/security-concepts)   
