...
<!-- I'm unsure whether "Management Connectors" are part of the name, or if those words should be lowercase. I'm guessing they should be lowercase in the title. Line 44 just calls them Power Platform for Admins connectors.  
Also, I haven't come across "Swagger" before - are you certain readers will know what it is? -->
