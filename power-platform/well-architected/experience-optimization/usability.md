...
When reasonable, support various input methods to accommodate users with different preferences and accessibility needs. Keyboard shortcuts, touch gestures, voice commands, or mouse clicks ensures users can interact with the interface using their preferred method.
...
:::image type="content" source="media/usability/h4.svg" alt-text="One UI pattern to open the next screen with a button control, and another pattern to open the screen with a link control.":::
...
:::image type="content" source="media/usability/h6.svg" alt-text="Comparison between a checklist with a set of options vs a set of text input fields for free text response.":::
...
:::image type="content" source="media/usability/h7.svg" alt-text="A filter pane with a link to 'saved filters', then the main filtering experience is shown below on the pane.":::
...
:::image type="content" source="media/usability/h10.svg" alt-text="Help pane flyout interface accessed from the top command bar.":::
