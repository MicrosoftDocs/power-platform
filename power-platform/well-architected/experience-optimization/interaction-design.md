...
| Term | Definition |
|-|-|
| Cognitive load | The total amount of mental effort required to perform a particular task or process information. It encompasses both the intrinsic cognitive load, inherent to the task's complexity, and extraneous cognitive load, caused by unnecessary elements or poor instructional design. Managing cognitive load is essential for learning, problem-solving, and decision-making. Excessive cognitive load can overwhelm individuals and reduce performance. |
| Decision fatigue | Refers to the deteriorating quality of decisions made by an individual after a long session of decision-making. As people make choices throughout the day, mental resources become depleted, leading to poorer decision-making abilities, impulsivity, and avoidance of decision-making altogether. This phenomenon can impact various aspects of life, from personal choices to professional decision-making.|
...
:::image type="content" source="media/interaction-design/affordance.svg" alt-text="Affordance example showing a depressed button next to a raised button.":::
...
:::image type="content" source="media/interaction-design/bias.svg" alt-text="The Müller-Lyer illusion shows two lines of the same length appear to be of different lengths because of variation in fin direction.":::

**The Müller-Lyer illusion demonstrates that despite the lines being objectively the same length, our brains interpret the lines differently due to the surrounding visual context (the fins), leading to the perceptual error (or  illusion), of one line being longer than the other.**
...
:::image type="content" source="media/interaction-design/hick.svg" alt-text="Graphic with 8 shapes (2 circles, squares, stars, triangles), each pair colored differently. Demonstrates Hick's Law on decision-making.":::

### Serial-position effect

Serial-position effect is the tendency to recall the first and last items in a series best, along with the most different element. Use the following tips to enhance memorability:
...
:::image type="content" source="media/interaction-design/serial-position.svg" alt-text="Line of 7 objects with arrows above first, last, and unique middle item. Illustrates selective attention and primacy/recency effects in cognitive psychology.":::
...
Miller's Law, stemming from George A. Miller's 1956 paper, reveals that the average person can hold about seven (plus or minus two) items in their working memory at once. This insight highlights the cognitive limitations of human information processing and has had significant implications across various fields, including user interface design. Miller's research continues to inform our understanding of memory capacity and influences strategies for optimizing cognitive performance and designing effective learning environments and interfaces.
...
:::image type="content" source="media/interaction-design/miller.svg" alt-text="7 circles, numbered (1 through 7), used to depict Miller's law.":::
...
:::image type="content" source="media/interaction-design/peak-end-rule.svg" alt-text="A continuous irregular wavy line drawn from left to right, with one arrow pointing at the highest peak and another at the lowest trough. Abstract depiction of the Peak-end rule.":::
...
:::image type="content" source="media/interaction-design/postel.svg" alt-text="Thumbs up and thumbs down icons, used as Postel's law depiction.":::
