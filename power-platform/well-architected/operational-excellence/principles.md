...
|Treat all **automation as a critical dependency** of your workload. Adapt to the workload's expected growth. <br><br>  Your automation tooling is an integral part of your workload, and it should adhere to the Power Platform Well-Architected pillars.     | Design your automation component to withstand risks, such as security threats. With applied best practices, you can avoid implementation sprawl.<br><br>The workload will continue to operate with a high-level guarantee if this dependency is kept functional and safe. |
