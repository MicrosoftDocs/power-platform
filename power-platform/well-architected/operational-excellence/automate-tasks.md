...
Power Platform offers many tools to help you automate tasks for your workload.

By using Microsoft Power Automate , you can use Power Platform itself to automate Power Platform workloads. When you build custom digital process automation (DPA) to handle workload tasks like approval flows, consider using [Power Automate](https://azure.microsoft.com/products/power-automate/). You can construct workflows from built-in connectors and templates. The large ecosystem of software as a service (SaaS) connectors enables you to connect apps, data, and devices in the cloud – such as Office 365 and Azure. You can use [Power Platform admin connectors](/connectors/powerplatformforadmins/) to connect to the Power Platform service itself and perform operational tasks, such as creating environments or sharing applications.
...
- Environment Request Management as part of the CoE Starter Kit
- CoE Starter Kit
- Approvals Kit
- ALM Accelerator
