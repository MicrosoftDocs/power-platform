...
To understand how each pillar can improve your intelligent application workload, consult [Design principles for intelligent application workloads](design-principles.md).
