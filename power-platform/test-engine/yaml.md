...
### testSettings user defined type YAML schema definition

| Property | Required | Description |
|---|---|---|
| powerFxTestTypes | No | A list of type name and Power Fx type definitions
...
### testSettings user defined functions YAML schema definition

| Property | Required | Description |
|---|---|---|
| testFunctions | No | A list of description and Power Fx function definitions
