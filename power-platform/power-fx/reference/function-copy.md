...
Copies text to the clipboard of the device where the app is running.
...
1. Insert a **Text input** control on a screen. By default, its name will be **TextInput1**.
2. Insert a **Button** control on the screen right next to the input control.
3. Set the button's **OnSelect** property to **Copy( TextInput1.Text )**.

When clicking the button, the text from the text input control will be copied to the clipboard.
