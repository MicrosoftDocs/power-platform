...
Shapes a [table](/power-apps/maker/canvas-apps/working-with-tables.md) by adding, dropping, renaming, and selecting its [columns](/power-apps/maker/canvas-apps/working-with-tables#columns).
