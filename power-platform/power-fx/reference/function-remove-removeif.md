...
1. Close the app preview.
    ...
    > [!TIP]
    > You can also use alternate behavior with [*Alt key*](/power-apps/maker/canvas-apps/keyboard-shortcuts#alternate-behavior) instead of using the app preview with *Play* button or *F5*.
