...
For both functions, units can be **Units.Milliseconds**, **Units.Seconds**, **Units.Minutes**, **Units.Hours**, **Units.Days**, **Units.Months**, **Units.Quarters**, or **Units.Years**. By default, both functions use **Units.Days** as units.
...
- _Units_ - Optional. The type of _Units_ to add: **Units.Milliseconds**, **Units.Seconds**, **Units.Minutes**, **Units.Hours**, **Units.Days**, **Units.Months**, **Units.Quarters**, or **Units.Years**. If not specified, **Units.Days** are used.
...
- _Units_ - Optional. The type of _Units_ to subtract: **Units.Milliseconds**, **Units.Seconds**, **Units.Minutes**, **Units.Hours**, **Units.Days**, **Units.Months**, **Units.Quarters**, or **Units.Years**. If not specified, **Units.Days** are used.
...
| **Text( DateAdd( Now(), 4, Units.Hours ),<br>"dd-mm-yyyy hh:mm" )**           | Add four hours to the current date and time.                                                   | "15-07-2013 17:02" |
| **Text( DateAdd( Today(), 1, Units.Months ),<br>"dd-mm-yyyy hh:mm" )**        | Adds one month to the current date, without time as **Today** doesn't return a time component. | "15-08-2013 00:00" |
| **Text( DateAdd( Now(), &#8209;30, Units.Minutes ),<br>"dd-mm-yyyy hh:mm" )** | Subtracts 30 minutes from the current date and time.                                           | "15-07-2013 12:32" |

### Simple DateDiff

| Formula                                              | Description                                                                                                                                                                 | Result |
| ---------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ |
| **DateDiff( Now(), DateValue("1/1/2014") )**         | Returns the difference between the two units in the default units of **Units.Days**                                                                                               | 170    |
| **DateDiff( Now(), DateValue("1/1/2014"), Units.Months )** | Returns the difference between the two values in **Units.Months**                                                                                                                 | 6      |
| **DateDiff( Now(), Today(), Units.Minutes )**              | Returns the difference between the current date/time and the current date only (no time) in minutes. Since the **Now** is later than **Today** the result will be negative. | -782   |
...
| Formula                                                                    | Description                                                                                                        | Result |
| -------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ | ------ |
| **DateDiff( TimeValue("09:45:00"), TimeValue("10:15:36"), Units.Hours )**        | The minutes/seconds are ignored, the difference is based on the time up to the hour.                               | 1      |
| **DateDiff( TimeValue("09:45:00"), TimeValue("10:15:36"), Units.Minutes )/60**   | The minutes are used in the difference, and the result is divided by 60 to have the difference in hours.           | 0.5    |
| **DateDiff( TimeValue("09:45:00"), TimeValue("10:15:36"), Units.Seconds )/3600** | The minutes and seconds are used in the difference; the result is divided by 3600 to have the difference in hours. | 0.51   |
...
- **DateAdd( Now(), TimeZoneOffset(), Units.Minutes )**
...
- **DateAdd( StartTime, &minus;TimeZoneOffset( StartTime ), Units.Minutes )**
