...
Also see [Date, Time, and DateTime data types](/power-apps/maker/canvas-apps/functions/data-types.md#date-time-and-datetime) and [working with dates and times](/power-apps/maker/canvas-apps/show-text-dates-times) for more information.
