...
Sorts a [table](/power-apps/maker/canvas-apps/working-with-tables.md).

## Description
The **Sort** function sorts a table based on a formula.  

The formula is evaluated for each [record](/power-apps/maker/canvas-apps/working-with-tables.md#records) of the table, and the results are used to sort the table.  The formula must result in a number, a string, or a Boolean value; it can't result in a table or a record.
...
You can combine **SortByColumns** with a **[Drop down](/power-apps/maker/canvas-apps/controls/control-drop-down.md)** or **[List box](/power-apps/maker/canvas-apps/controls/control-list-box.md)** control to enable users to select which column to sort by.
...
[Tables](/power-apps/maker/canvas-apps/working-with-tables.md) are a value in Power Apps, just like a string or number.  They can be passed to and returned from functions.  **Sort** and **SortByColumn** don't modify a table; instead they take a table as an argument and return a new table that has been sorted.  See [working with tables](/power-apps/maker/canvas-apps/working-with-tables.md) for more details.
...
### Step by step
To run these examples yourself, create the **IceCream** data source as a [collection](/power-apps/maker/canvas-apps/working-with-data-sources.md#collections):

1. Add a button, and set its **[OnSelect](/power-apps/maker/canvas-apps/controls/properties-core.md)** property to this formula:<br>**ClearCollect( IceCream, { Flavor: "Chocolate", Quantity: 100, OnOrder: 150 }, { Flavor:  "Vanilla", Quantity: 200, OnOrder: 20 }, { Flavor: "Strawberry", Quantity: 300, OnOrder: 0 }, { Flavor: "Mint Chocolate", Quantity: 60, OnOrder: 100 }, { Flavor: "Pistachio", Quantity: 200, OnOrder: 10 } )**
...
#### Sort
1. Add another button, and set its **[OnSelect](/power-apps/maker/canvas-apps/controls/properties-core.md)** property to this formula:<br>
