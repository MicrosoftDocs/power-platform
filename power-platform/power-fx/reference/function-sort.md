...
You can combine **SortByColumns** with a **[Drop down](/power-apps/maker/canvas-apps/controls/control-drop-down.md)** or **[List box](/power-apps/maker/canvas-apps/controls/control-list-box)** control to enable users to select which column to sort by.
