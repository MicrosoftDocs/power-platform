...
Some of these operators are dependent on the language of the author.  See [Global apps](global.md) for more information.
...
| *   |   &nbsp;   |   **2 \* 3**      |       Multiplication    |
|                                **/**                                |                       &nbsp;                        |                                                                                  **2 / 3**                                                                                   |                                                                                                   Division (also see the **[Mod](/powerapps/maker/canvas-apps/functions/function-mod)** function)                                                                                                    |
|                                **^**                                |                       &nbsp;                        |                                                                                  **2 ^ 3**                                                                                   |                                                                                          Exponentiation, equivalent to the **[Power](/powerapps/maker/canvas-apps/functions/function-numericals)** function                                                                                          |
...
|                      **&amp;&amp;** or **And**                      |                  Logical operators                  |                                       **Price &lt; 100 &amp;&amp; Slider1.Value = 20**<br>or **Price &lt; 100 And Slider1.Value = 20**                                       |                                                                                         Logical conjunction, equivalent to the **[And](/powerapps/maker/canvas-apps/functions/function-logicals)** function                                                                                          |
|                     **&#124;&#124;** or **Or**                      |                       &nbsp;                        |                                        **Price &lt; 100 &#124;&#124; Slider1.Value = 20** or **Price &lt; 100 Or Slider1.Value = 20**                                        |                                                                                          Logical disjunction, equivalent to the **[Or](/powerapps/maker/canvas-apps/functions/function-logicals)** function                                                                                          |
|                          **!** or **Not**                           |                       &nbsp;                        |                                                              **!(Price &lt; 100)** or **Not (Price &lt; 100)**                                                               |                                                                                           Logical negation, equivalent to the **[Not](/powerapps/maker/canvas-apps/functions/function-logicals)** function                                                                                           |
...
| **;**<br>[[language dependent](globals.md)] |                  Formula chaining                   |                                     **Collect(T, A); Navigate(S1, &quot;&quot;)**                                     |                                                                          Separate invocations of functions in behavior properties. The chaining operator depends on the language.                                                                          |
...
2. Set the **[Items](/powerapps/maker/canvas-apps/controls/properties-core)** property of the gallery to this formula:
...
| **ThisRecord** | **[ForAll](/powerapps/maker/canvas-apps/functions/function-forall)**, **[Filter](/powerapps/maker/canvas-apps/functions/function-filter-lookup)**, **[With](/powerapps/maker/canvas-apps/functions/function-with)**, **[Sum](/powerapps/maker/canvas-apps/functions/function-aggregates)** and other [record scope](/powerapps/maker/canvas-apps/working-with-tables) functions |  The default name for the current record in **ForAll** and other record scope functions. |
| **As** *name* | **[Gallery](/powerapps/maker/canvas-apps/controls/control-gallery)**&nbsp;control<br>**[ForAll](/powerapps/maker/canvas-apps/functions/function-forall)**, **[Filter](/powerapps/maker/canvas-apps/functions/function-filter-lookup)**, **[With](/powerapps/maker/canvas-apps/functions/function-with)**, **[Sum](/powerapps/maker/canvas-apps/functions/function-aggregates)** and other record scope functions | Defines a *name* for the current record, replacing default **ThisItem** or **ThisRecord**.  Use **As** to make formulas easier to understand and resolve ambiguity when nesting. |
...
- We start by iterating an unnamed table of 8 numbered records from the [**Sequence**](/powerapps/maker/canvas-apps/functions/function-sequence) function.  This loop is for each row of the board, which is commonly referred to as **Rank** and so we give it this name.
...
- [**Concat**](/powerapps/maker/canvas-apps/functions/function-concatenate) is used twice, first to assemble the columns and then the rows, with a [**Char(10)**](/powerapps/maker/canvas-apps/functions/function-char) thrown in to create a new line.
