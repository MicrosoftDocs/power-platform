...
* You set the value of the global variable with the **[Set](f/powerapps/maker/canvas-apps/functions/function-set)** function.  **Set( MyVar, 1 )** sets the global variable **MyVar** to a value of **1**.
