...
## Prerequisites
 ...
 1. [Set up SAP Connection](getting-started-with-the-sap-erp-connector.md). Be sure to use version July 2024 - 3000.230 or higher of the [On-premise data gateway](https://powerapps.microsoft.com/downloads/).
