...
- [Get started with the SAP ERP connector](./sap/connect/sap-erp-connector.md)
- [Get started with the OData connector](./sap/connect/sap-odata-connector.md)
- [Set up Microsoft Entra ID using certificates(SSO)](./sap/connect/entra-id-certs.md)
