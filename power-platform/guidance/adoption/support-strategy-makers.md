...
| :::image type="icon" source="media/support-3.png" border="false"::: | **[Power Platform Nurture team (internal)](roles.md#microsoft-power-platform-nurture-team)** is responsible for enabling Power Platform at the organization level. This team may provide mentorship to makers and help them build apps/flows. It will also lead community programs and events, such as hackathons. |
