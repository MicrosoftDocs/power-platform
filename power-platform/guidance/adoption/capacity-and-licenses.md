...
To create new Microsoft Power Platform environments with or without Common Data Service, there must be at least 1 GB of Common Data Service database capacity remaining. Capacity is also consumed by normal Common Data Service storage consumption by storing data, files, and logs.
