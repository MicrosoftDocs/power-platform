...
- **Permission governance:** The dynamic nature of their teams resulted in individuals being spread across various locations and roles. The ongoing challenge was to ensure that everyone had the right access at the right time.

- **Technological diversity:** Managing permissions for a multitude of technologies was a continuous learning and implementation process. Each technology comes with its unique set of rules and protocols for access and permissions, which adds to the complexity.

- **Integration deficit:** Operations often involve using standard business technologies like Workday and Oracle, as well as platforms like Autodesk, Revizto, and Bluebeam. However, the lack of integration between these technologies and the team’s permission governance systems posed an added challenge.

- **Decentralized and inefficient technology setup tracking:** Before AECOM implemented Power Platform, tracking technology setups across multiple projects was fragmented and inefficient. Teams relied on various manual processes, spreadsheets, and communication channels, which led to gaps in tracking and oversight. 
...
> [!NOTE]  
> Project Connect also features similar screens for adding users to ACC and Revizto. 
...
The development and implementation of the Project Connect application leveraged a variety of Microsoft and Power Platform technologies. These tools were essential in creating a seamless and efficient onboarding process. Here are the key technologies used:

- **Power Apps:** Serves as the main application interface that end users interact with, to onboard users to different technology platforms. AECOM used canvas apps for Project Connect and model-driven applications (MDA) for the Admin screen.

- **Power Automate:** Power Automate flows are also used to retrieve and consolidate information on users who are currently assigned to a project across both platforms. Flows are Power Automate workflows. The flows utilize the APIs of Autodesk Construction Cloud (ACC) and Revizto to onboard members into the respective technology platforms.
...
- **Microsoft Fabric:** Facilitates data engineering activities by consolidating data from multiple sources and storing it in a data warehouse, which enables comprehensive reporting and analysis.
...
- **Copilot:** Accelerates the development process by leveraging Copilot capabilities for Dataverse, PowerApps, and Power Automate, to streamline workflows and boost productivity.
...
7.  The cost information is sent to Power BI, where it is analyzed and visualized in a dashboard.
...
4.  The access data is sent from the platforms to the Project Connect application:
...
10. The project information is then sent to the Power BI dashboard, along with the previous cost information, in order to automatically analyze and visualize project onboarding data in a dashboard.

## Takeaways

The implementation of the Project Connect application has led to significant improvements across various platforms. Here are the key impacts:

- **Simplified onboarding process**: The single-view Project Connect application streamlines the onboarding process across multiple platforms, including SharePoint, Autodesk Construction Cloud (ACC), and Revizto. Users only need to familiarize themselves with the Power Apps application designed by AECOM to be simple and easy to use. This eliminates the need for team members to learn the different user interfaces of the current platforms.

- **Enhanced efficiency and reduced learning curve**: The streamlined process has significantly enhanced efficiency and reduced the learning curve. This strategic shift allows the administrative team to take on the responsibility of onboarding, which freed the designers to focus on their core project tasks. With the new automation and tool integration, the administrative team increased their responsibilities and impact.

- **Integration with core business software**: The Project Connect application integrates with the organization’s core business software, such as Workday and the Project Cost Tool. This greatly increased user management productivity and provides AECOM with profound insights into the complexity of permissions and access rights across all the various technology stacks for their project teams.

- **Centralized tracking of technology setups**: The solution offers an easy, centralized way to track technology setups across all their projects. Centralized tracking ensures that nothing is overlooked and project teams have all the tools they need from the start. 
...
- **Streamlined user access management:** Managing user access across different projects and technology platforms has become much easier. Administrators benefit from better control and reduced complexity without having to manage multiple platforms.
