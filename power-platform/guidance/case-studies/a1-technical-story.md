...
To setup the copilot component, create a new copilot in Copilot Studio then a new topic. Describe what the topic does using keywords that copilot can use to detect and trigger the next steps.
