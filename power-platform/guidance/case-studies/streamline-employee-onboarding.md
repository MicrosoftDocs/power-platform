...
Read the full story: [Epiq uses Microsoft Copilot Studio and other Power Platform tools to drive efficiency and reduce costs](https://www.microsoft.com/customers/story/23132-epiq-global-microsoft-power-platform)
...
> My goal throughout this solution is that every step we take to gather more data, we're aggregating that data in their record in Dataverse&mdash;so when we have to look it up later in the process, we're only looking up against Dataverse.
>
> — *Colton Coan, Senior Director of Rapid Development*
...
> The biggest challenge we've had over three years that this solution solved was that when people fill out the form, some put a comma-delimited list, some do semicolons. We're using the GPT model of AI Builder to normalize that data.
>
> — *Colton Coan, Senior Director of Rapid Development*
