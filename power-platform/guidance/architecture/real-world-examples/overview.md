...
The following articles represents several architectures implemented by real customers when building their Power Apps solution. For each article, an overview of the features used in the solution is provided along with some advantages and gotchas.
