...
| TenantID | Your Azure tenant ID, check [Find Tenant ID throught the Azure Portal](../../fundamentals/active-directory-how-to-find-tenant#find-tenant-id-through-the-azure-portal)|
...
| TenantID | Your Azure Tenant ID, check [Find Tenant ID throught the Azure Portal](../../fundamentals/active-directory-how-to-find-tenant#find-tenant-id-through-the-azure-portal)| Not applicable|
