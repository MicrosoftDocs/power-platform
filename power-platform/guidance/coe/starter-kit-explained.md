...
The Center of Excellence (CoE) Starter Kit is shipped in multiple modules:<!--note from editor: Is there a reason to use "modules" here? They don't seem to be mentioned anywhere else in the docset.-->

- **Center of Excellence – core components module**  
...
- **Center of Excellence – governance components module**  
...
- **Center of Excellence – nurture components module**  
...
- **Center of Excellence – theming components module**  

    A frequent ask from organizations in which makers create canvas apps is the ability to apply themes&mdash;specifically, the ability to create apps that match the organizational brand. The assets in this solution will help you create, manage, and share themes.<!--note from editor: Edit suggested.-->
