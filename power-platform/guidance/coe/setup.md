...
You can't set up [DLP endpoint filtering](/power-platform/admin/connector-endpoint-filtering) for these connectors, as dynamic endpoint evaluation isn't supported by DLP Policies.
