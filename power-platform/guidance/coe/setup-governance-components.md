...
1. Download and import this flow into your CoE environment. (Go to [https://flow.microsoft.com/](https://flow.microsoft.com/) > Select the Environment of the CoE > My Flows > Import
