...
description: "The Environment Management componenets in the Core solution will help automate and manage requests for development resoruces."
author: denisem-msft
manager: devkeydet
...
**Solution**: The below process can be used by non-admins to request new environments. Automation has been designed to   
...
1. Select + New
1. In the flyout menu, choose the desired connectors that will be needed in the new environment. Then select Next.
...
1. Indicate if the environment can be automatically cleaned up after a certian period of time. 
