...
1. The ALM Accelerator solution has a dependency on the [Creator Kit](/power-platform/guidance/creator-kit/overview). To install the Creator Kit follow the instructions in the [Creator Kit setup documentation](/power-platform/guidance/creator-kit/setup)
