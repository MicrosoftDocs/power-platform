...
1. Microsoft entra permissions may be required to configure the Microsoft Entra app registration. Depending on your Entra configuration this could be **Application Developer** role or higher. Review the [Least privileged roles by task in Microsoft Entra ID](h/entra/identity/role-based-access-control/delegate-by-task) fore more guidance.
