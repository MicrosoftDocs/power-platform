...
1. Go to the Definition tab and verify if there are 3 **Policies** created, in case you don't find the policies, follow the steps  [on this section](/power-platform/guidance/coe/setup-almacceleratorpowerplatform-upgrade-config#create-the-customazuredevops-custom-connector-policies).
