...
1. Initially, you will need to manually sync a copy of the pipeline templates from <https://github.com/microsoft/coe-alm-accelerator-templates/blob/main/Pipelines/>. Follow the steps in the [setup-almacceleratoradvanced.md](setup-almacceleratoradvanced.md#Clone-the-YAML-Pipelines-from-GitHub-to-your-Azure-DevOps-instance) to clone the pipeline template repo to your Azure DevOps repo.
