...
description: Learn about the details and properties of SearchBox control in the Creator Kit.
author: denisem-msft
manager: devkeydet
...
This Canvas component mimics the style and behavior of the [Fluent UI Search control](https://developer.microsoft.com/fluentui#/controls/web/searchbox).
...
| -------- | ----------- |
| `HintText` | The hint text displayed when there is no text. |
| `Text` | The value of the text in the SearchBox. |

## Configure search behavior
Add the `SearchBox` control to your app where you need a search interface, which is usually coupled with a gallery, `DetailsList`, or some control that can display a data set.
...
## Best Practices
Refer to [Fluent UI SearchBox control best practices](https://developer.microsoft.com/fluentui#/controls/web/searchbox)
