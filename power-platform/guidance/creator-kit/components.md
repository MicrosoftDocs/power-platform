...
| [`SpinButton`](spinbutton.md) | User Interface | Provides a wrapper around the [Fluent UI `SpinButton`](https://developer.microsoft.com/fluentui#/controls/web/spinbutton) control for use in canvas apps and custom pages. | Yes | Yes | Yes | No |
