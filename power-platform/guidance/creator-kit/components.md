...
| [`Facepile`](dialog.md) | User Interface | Mimics the style and behavior of the [Fluent UI `Faceoile` component](https://developer.microsoft.com/fluentui#/controls/web/facepile). | Yes | Yes | Yes| No |
