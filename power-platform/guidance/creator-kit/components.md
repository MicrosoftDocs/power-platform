...
| [`Dialog`](dialog.md) | User Interface | The `Dialog` canvas component mimics the style and behavior of the [Fluent UI `Dialog` component](https://developer.microsoft.com/fluentui#/controls/web/dialog) from inside canvas apps and custom pages. | &check; | &check; | &check;| &cross; |
| [`Elevation`](elevation.md) | User Interface | Fluent UI elevation support with mouse hover events. | &check; | &check; | &check; | &cross; |
| [`ExpandMenu`](expandmenu.md) | User Interface | A canvas component that provides a navigation interface. | &cross; | &check; | &check; | &cross; |
...
| [`Panel`](panel.md) | User Interface | The `Panel` canvas component mimics the style and behavior of the [Fluent UI `Panel` component](https://developer.microsoft.com/fluentui#/controls/web/panel) from inside canvas apps and custom pages. | &check; | &check; | &check;| &cross; |
...
| [`ProgressIndicator`](progressindicator.md) | User Interface | The `ProgressIndicator` canvas component mimics the style and behavior of the [Fluent UI `ProgressIndicator` component](https://developer.microsoft.com/fluentui#/controls/web/progressindicator) from inside canvas apps and custom pages. | &check; | &check; | &check;| &cross; |
...
| [`SearchBox`](searchbox.md) | User Interface | The `SearchBox` canvas component mimics the style and behavior of the [Fluent UI `SearchBox` component](https://developer.microsoft.com/fluentui#/controls/web/searchbox) from inside canvas apps and custom pages. | &check; | &check; | &check;| &cross; |
| [`Spinner`](spinner.md) | User Interface | The `Spinner` canvas component mimics the style and behavior of the [Fluent UI `Spinner` component](https://developer.microsoft.com/fluentui#/controls/web/spinner) from inside canvas apps and custom pages. | &check; | &check; | &check;| &cross; |
