...
>[IMPORTANT]
>The flow that can be called from a topic must be in the same [Common Data Service environment](https://docs.microsoft.com/en-us/powerapps/maker/common-data-service/data-platform-intro) as your bot.
