...
>Flows must also be in a solution in Power Automate. You can [move flows into solutions](#move-a-flow-to-the-solutions-tab-on-the-microsoft-automate-portal) so they are listed in the authoring canvas.
