...
You need to register a new app with your identity provider and get a Client ID and Client Secret before you can configure authentication in Power Virtual Agents. This section describes how to do that with the [Azure portal](https://portal.azure.com) for AAD. If you have a different identity provider, please consult its setup instructions.
