...
1. Go to the **Topics** tab on the side navigation pane to open the topics page.
   ...
   :::image type="content" source="media/topics-menu.png "Select Topics on the side navigation menu"" alt-text="Select Topics on the side navigation menu." border="false":::

1. On the topics page, select **New topic**.

   :::image type="content" source="media/topics-new.png "Select New topic at the top of the Topics page"" alt-text="Select New topic at the top of the Topics page." border="false":::
...
1. Specify a name, description, and one or more trigger phrases for the topic.
   ...
   :::image type="content" source="media/topics-details-triggers.png "The Topic details page contains a name, description, and trigger phrases"" alt-text="The Topic details page contains a name, description, and trigger phrases." border="false":::
...
1. In the topic details for the topic you want to edit, select **Go to authoring canvas**.
   ...
   :::image type="content" source="media/topics-details-canvas.png "The Go to authoring canvas is to the side of the trigger phrases"" alt-text="The Go to authoring canvas is to the side of the trigger phrases." border="false":::
...
1. You can add additional nodes by selecting the **Plus** (**+**) icon on the line or branch between or after a node.
   ...
   :::image type="content" source="media/handoff-add-node.png "Screenshot of adding a node"" alt-text="Screenshot of adding a node." border="false":::
...
1. To have the bot ask a question and get a response from the user, select **+** to add a node, and then **Ask a question** to add a new **Question** node.
   ...
   :::image type="content" source="media/topics-question.png "Add a new question mode"" alt-text="Add a new question mode." border="false":::
...
>
>    :::image type="content" source="media/topics-question-options.png "Select options for users"" alt-text="Select options for users." border="false":::
>
> 1. Select the **Synonyms** icon for the option you want to add additional keywords to. 
>
>    :::image type="content" source="media/topics-question-synonyms.png "Select the synonyms icon"" alt-text="Select the synonyms icon." border="false":::
>
...
1. At the end of a response that resolves the user's issue or answers the question, select **End the conversation**.
    ...
    :::image type="content" source="media/topics-nodes-end.png "End the conversation"" alt-text="End the conversation." border="false":::

1. To end with a customer satisfaction survey, select **End with survey**.
    
    :::image type="content" source="media/topics-nodes-survey.png "End with survey"" alt-text="End with survey." border="false":::
...
1. Select **Transfer To Agent** to insert a hand-off node that will link with your [configured hand-off product](configuration-hand-off-omnichannel.md). You can also enter a private message to the agent.
    ...
    :::image type="content" source="media/topics-nodes-handoff.png "Transfer To Agent"" alt-text="Transfer To Agent." border="false":::
...
1. Choose the variable you want to use to determine if the bot conversation should branch at this point. For example, if you have set up [end-user authentication](advanced-end-user-authentication.md), then you might want to specify a different message if the user is signed on (which may have happened earlier in the conversation).
    ...
    :::image type="content" source="media/topics-branch.png "Choose a variable"" alt-text="Choose a variable." border="false":::
...
1. Select **Delete**.
    ...
    :::image type="content" source="media/topics-delete.png "Select the menu icon and then the delete button"" alt-text="Select the menu icon and then the delete button." border="false":::
