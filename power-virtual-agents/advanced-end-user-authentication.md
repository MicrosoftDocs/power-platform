...
The **Authenticate** node outputs a set of authentication variables depending on your [authentication settings](https://docs.microsoft.com/en-us/power-virtual-agents/configuration-end-user-authentication).
