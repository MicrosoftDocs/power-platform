...
This feature is available in the preview and has not changed. For more information, see [Add end-user authentication (production)](../advanced-end-user-authentication.md).