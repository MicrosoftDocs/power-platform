...
description: Use conversation topics in the authoring canvas for an intuitive, no-code way to create a bot that can help answer user questions, perform actions, and solve issues in Power Virtual Agents preview.
keywords: "PVA"
ms.date: 10/10/2022
