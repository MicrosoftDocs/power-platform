...
:::image type="content" source="media/bot-variable-message.png "Screenshot showing selection of the x variable icon to display a list of variables"" alt-text="Screenshot showing selection of the x variable icon to display a list of variables." border="false":::
...
:::image type="content" source="media/bot-variable-delete.png "The bot variable delete message indicates that references to that variable will be labeled as unknown"" alt-text="The bot variable delete message indicates that references to that variable will be labeled as unknown." border="false":::
