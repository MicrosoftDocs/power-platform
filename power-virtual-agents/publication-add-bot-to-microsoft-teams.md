...
- [Setting the bot avatar icon](customize-default-canvas.md) from the side pane **Settings** > **General** will not show up for bots that are approved by an admin. Bots approved by an admin will use the app icon as the bot avatar.
