...
| `va_Topics`                                                  | Helps ramp-up a live agent. Only includes topics triggered by end user using a trigger phrase. Does not include topics that were redirected to.                                                                                                                      | `[ "Greetings", "Store Hours", "Return Item" ]`           |
