...
- You must use the [preview version of Power Virtual Agents](https://learn.microsoft.com/power-virtual-agents/preview/overview), and the bot type must be Preview. 
