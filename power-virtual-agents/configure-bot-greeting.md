...
2. Under **System Topics**, select the **Go to authoring canvas** icon on the **Greeting** topic row.
    ...
    :::image type="content" source="media/custom-greeting-topic.png "Screenshot of the Topics page, with the Greeting topic highlighted"" alt-text="Screenshot of the Topics page, with the Greeting topic highlighted." border="false":::
...
4. Select **Save** when you're finished editing the message.
    ...
    :::image type="content" source="media/custom-greeting-message.png "Screenshot of the system greeting topic showing the message nodes that can be edited"" alt-text="Screenshot of the system greeting topic showing the message nodes that can be edited." border="false":::

5. [**Publish** your bot](publication-fundamentals-publish-channels.md).

    :::image type="content" source="media/channel-publish-latest-content.png "Publish latest bot content"" alt-text="Publish latest bot content." border="false":::
