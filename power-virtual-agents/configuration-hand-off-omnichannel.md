...
If you previously had connected a bot to Omnichannel (before November 2021), and want to enable voice-based capabilities, you must [disconnect and reconnect the bot to Omnichannel](#disconnect-your-bot-from-omnichannel-or-disable-the-omnichannel-connection).
