...
1. Return to the **Omnichannel** pane in Power Virtual Agents and paste the Application ID in the **Application ID** box.
    ...
    > [!IMPORTANT]
    > Omnichannel for Customer Service models bots as "application users." As a result, the Application ID that you use **must be unique** to your Power Virtual Agents bot. Reusing an Application ID across bots will cause a generic error to be shown. 
