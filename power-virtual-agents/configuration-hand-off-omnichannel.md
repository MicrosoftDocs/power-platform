...
* Environments:
  * You must install the [extension solutions](#install-extension-solutions) in the same environment where you have your bots.
  ...
  - For voice-based capabilities, both your tenant _and_ environment must be in the [same geographic location](data-location.md#data-locations), i.e. both in the United States, Europe, Asia, or Australia geographies.
