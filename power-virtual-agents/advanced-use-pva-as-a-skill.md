...
1. [Add the Bot Framework bot to the allowlist for the Microsoft Copilot Studio copilot](#add-your-bot-framework-bot-to-the-allowlist-for-your-microsoft-copilot-studio-bot).
1. [Download the skill manifest for the Microsoft Copilot Studio copilot](#download-the-bot-skill-manifest-for-your-microsoft-copilot-studio-bot).
