...
1. You download the skill manifest for the Power Virtual Agents bot.
1. You use the downloaded skill manifest in Bot Framework Composer to create a connection between the bots.
1. You test the bot works as a skill by using the Bot Framework Emulator.
...
1. In Power Virtual Agents, expand the **Manage** tab for the bot you want to use as a skill, and go to **Skills**.
...
1. Select **Manage allowlist** on the top menu bar.
    ...
    >[!TIP]  
    >You can also get to your bot's allowlist by going to **Manage** > **Security**.
    >
...
1. Select what Power Virtual Agents bot skill's topics you want to add to your Bot Framework bot and select **Next**.
...
1. Review and edit your Power Virtual Agents bot skill's trigger phrases and select **Next**.
