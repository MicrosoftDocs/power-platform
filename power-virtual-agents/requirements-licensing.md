...
2. On the navigation pane, expand the **Users** menu, and then select **Active users**.
    ...
    :::image type="content" source="media/licensing-menu-users.png "Expand Users, and then select Active users"" alt-text="Expand Users, and then select Active users." border="false":::

3. Select a name, and then select **Manage product licenses**.

   :::image type="content" source="media/licensing-manage.png "Select a user, and then manage product licenses"" alt-text="Select a user, and then manage product licenses." border="false":::
