...
## Overview
  ...
  :::image type="content" source="media/generic-adapter-illustration.png "ILLUSTRATION SHOWING GENERIC ADAPTER DATAFLOW"" alt-text="ILLUSTRATION SHOWING GENERIC ADAPTER DATAFLOW.":::
