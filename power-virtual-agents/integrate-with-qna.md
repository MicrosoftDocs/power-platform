...
To learn how to use QnA maker in a fallback topic, see [Add your knowledge base to Power Virtual Agents](https://aka.ms/QuestionAnsweringConnectorWithPowerVirtualAgents).
