...
When you publish your bot, the calls are made on behalf of the user chatting witht the bot using the authentication seeting configured in the bot, which much use manual authentication with Service Provider type of "Azure AD". 
