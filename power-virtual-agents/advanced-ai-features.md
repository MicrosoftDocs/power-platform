...
[After you enable advanced AI capabilities](#enable-or-disable-ai-capabilities), go to **Analytics** in the navigation menu, then go to the **Topic triggering (preview)** tab, where a list of overlapped topics will be displayed.
