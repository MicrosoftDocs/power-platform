...
1. If the **Test bot** pane is hidden, open it by selecting **Test your bot**.
   ...
   :::image type="content" source="media/authoring-test-bot/test-bot-menu.png" alt-text="The Test your bot button is at the bottom of the side navigation pane." border="false":::
...
1. At the top of the **Test bot** pane, set **Track between topics** to **On**.
   ...
   :::image type="content" source="media/authoring-test-bot/test-bot-track.png" alt-text="Switch the track bettern topics toggle at the top of th test bot pan." border="false":::
