...
2. Select **Copy** for either **Secret 1** or **Secret 2** to copy it to the clipboard. Select the visibility icon :::image type="content" source="media/configure-web-security/visibility-icon.png" alt-text="Visibility icon." border="false"::: to reveal the secret. A warning prompt will appear before you can reveal it.
