...
>
> By default, only admins have the **Copilot transcript viewer** or **Bot transcript viewer** role assigned. We recommend you create an environment for copilots that controls which user can view conversation transcripts. Learn more about how to [Create a new environment for your copilots](./environments-first-run-experience.md#create-a-new-environment-for-your-copilots)
