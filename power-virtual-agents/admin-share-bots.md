...
:::image type="content" source="media/admin-share-bots/sharing-multi-details.png" alt-text="Screenshot of a topic's details page on the properties pane with the Modified by section on the right highlighted.":::
