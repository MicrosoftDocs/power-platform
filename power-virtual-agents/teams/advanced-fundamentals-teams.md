...
[Trigger hand-off to a live agent](advanced-hand-off-teams.md) | Send entire transcripts of a bot conversation to a live agent when the bot isn't able to resolve the issue.