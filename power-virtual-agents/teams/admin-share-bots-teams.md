...
1. Select **Share** at the top of the bot's home page.
  ...
  :::image type="content" source="media/admin-share-bots-teams/sharing-bot-homepage-teams.PNG" alt-text="Sharing UI entry point in bot homepage.":::
...
2. Specify the security group name that you would like to share the bot with.
  ...
  :::image type="content" source="media/admin-share-bots-teams/sharing-bot-specify-security-group-teams.PNG" alt-text="Specify security group in Sharing UI.":::

3. Review the security group's permissions.

  :::image type="content" source="media/admin-share-bots-teams/sharing-review-sg-permission-teams.PNG" alt-text="Review security group permission in Sharing UI.":::
...
3. Select **User - can use the bot** option.
  ...
  :::image type="content" source="media/admin-share-bots-teams/sharing-share-everyone-in-org-teams.PNG" alt-text="Set user permission for everyone in the organization in Sharing UI.":::
...
2. Select **X** next to the security groups that you want to stop sharing the bot with.
  ...
  :::image type="content" source="media/admin-share-bots-teams/sharing-unshare-sg-teams.PNG" alt-text="Unshare security group in Sharing UI.":::
...
3. Select **None** option.
  ...
  :::image type="content" source="media/admin-share-bots-teams/sharing-unshare-everyone-in-org-teams.PNG" alt-text="Unshare everyone in the organization in Sharing UI.":::
...
:::image type="content" source="media/admin-share-bots-teams/admin-share-bots-list.png" alt-text="The teams and chatbots are listed in the Chatbots tab.":::
...
:::image type="content" source="media/admin-share-bots-teams/admin-share-bots-edit.png" alt-text="The Topics and Analytics buttons appear when a bot is selected.":::
...
:::image type="content" source="media/admin-share-bots-teams/admin-share-bots-hamburger.png" alt-text="The bot's menu lets you edit details, topics, and see analytics":::
...
:::image type="content" source="media/admin-share-bots-teams/sharing-multi-authors-teams.png" alt-text="Screenshot showing the Power Virtual Agents list of topics with the Currently editing column highlighted.":::
...
:::image type="content" source="media/admin-share-bots-teams/sharing-multi-details-teams.png" alt-text="Screenshot of a topic's details page on the properties pane with the Modified by section on the right highlighted.":::
...
:::image type="content" source="media/admin-share-bots-teams/sharing-multi-editing-teams.png" alt-text="Screenshot of a topic being edited with user profile pictures appearing on the top menu bar.":::
...
:::image type="content" source="media/admin-share-bots-teams/sharing-multi-conflict-teams.png" alt-text="Screenshot showing a prompt that says Updated content available and gives you options to discard your changes or save a copy." border="false":::
