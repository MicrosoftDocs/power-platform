...
This article is intended for system administrators or IT professionals who are familiar with [Bot Framework skills](/azure/bot-service/skills-conceptual?view=azure-bot-service-4.0). After a skill has been registered with a Power Virtual Agents bot, authors can seamlessly [trigger skill actions in conversation](advanced-use-skills-teams.md).
...
First, [create a Power Virtual Agents bot](authoring-first-bot-teams.md) and [create and deploy skill using pro-code tools](https://go.microsoft.com/fwlink/?linkid=2110533) into your organization.
...
1. In the [Power Virtual Agents portal](https://powerva.microsoft.com), on the side navigation pane, expand the **Manage** menu and select **Skills**.
   ...
   ![Select Manage, then Skills](media/skills-menu-teams.png)

1. At the top of the skills page, select **Provide ID for allow list**.
 
   ![Select Provide id for allow list button](media/skills-provide-id-teams.png)

1. A window will show with your unique ID. Copy this ID and provide it to your skills developer.

   ![Windows showing unique ID](media/skills-provide-id-modal-teams.png)
...
1. At the top of the skills page, select **Add skill**.
   ...
   ![Select Add skill button](media/skills-add-skill-teams.png)
...
1. Select **Next** to begin the [validation process](#troubleshooting-errors-during-skill-registration). When successful, your skill is added to your bot. You can now [use this skill in your topics](advanced-use-skills-teams.md). 
