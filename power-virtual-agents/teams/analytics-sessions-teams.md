...
1. Click on each row to download the session transcripts for the specified timeframe.
    ...
    :::image type="content" source="media/analytics-sessions-teams/analyze-sessions-teams.png" alt-text="Screenshot of the sessions download page in the Power Virtual Agents app in Teams.":::
