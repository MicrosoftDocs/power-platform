...
:::image type="content" source="media/error-codes-teams/c2-error.png" alt-text="Bot error message displayed to users.":::
...
:::image type="content" source="media/error-codes-teams/c1-error.png" alt-text="Bot error message displayed to bot makers.":::
