...
1. On the side navigation pane, select **Manage** and then **Details**.
    ...
    :::image type="content" source="media/customize-default-canvas-teams/custom-canvas-details-teams.png" alt-text="The Details tab is found in the Manage section on the side navigation pane.":::
...
3. When you're finished, select **Save** on the top menu bar.
    ...
    :::image type="content" source="media/customize-default-canvas-teams/custom-canvas-save-teams.png" alt-text="Save is at the top of the window.":::
