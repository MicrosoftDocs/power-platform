...
1. Select **Topics** on the side navigation pane.
    ...
    :::image type="content" source="media/advanced-create-topics-from-web-teams/topics-web-tab.png" alt-text="The Topics menu item on the navigation pane.":::
...
5. Enter each webpage or file you want to extract content from, and then select **Add**. The URLs must be secure (they must start with *https://*). If you add a page by mistake, you can remove it by selecting **Delete** :::image type="content" source="media/advanced-create-topics-from-web-teams/delete-suggested-topic-teams.png" alt-text="Delete." border="false":::.
...
1. To add the topic to your bot, select the **Add to topics** icon :::image type="content" source="media/advanced-create-topics-from-web-teams/add-to-topics-teams.png" alt-text="Add to topics." border="false":::. You won't see a preview of the topic, and the topic will be automatically moved to the list of "Existing" topics.


    :::image type="content" source="media/advanced-create-topics-from-web-teams/suggested-web-quick-teams.png" alt-text="An up arrow icon next to the title of a topic." border="false":::
