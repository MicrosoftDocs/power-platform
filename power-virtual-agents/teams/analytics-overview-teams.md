...
![Opening the Analytics dashboard](media/analytics-open-teams.png "Opening the Analytics dashboard")
...
[Analyze session information](analytics-sessions-teams.md) | Review and monitor how sessions are doing, including analytics from the topics triggered during a session.
