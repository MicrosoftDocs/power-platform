...
:::image type="content" source="media/advanced-proactive-message-teams/image1.png" alt-text="Post message action in Power Automate.":::
...
:::image type="content" source="media/advanced-proactive-message-teams/image2.png" alt-text="Post adaptive card action in Power Automate.":::
...
:::image type="content" source="media/advanced-proactive-message-teams/image3.png" alt-text="Post adaptive card and wait for response action in Power Automate.":::

:::image type="content" source="media/advanced-proactive-message-teams/image4.png" alt-text="Post adaptive card and wait for response update message.":::
...
:::image type="content" source="media/advanced-proactive-message-teams/image5.png" alt-text="Dynamic content selection in a flow.":::
...
:::image type="content" source="media/advanced-proactive-message-teams/image6.png" alt-text="Send to teammates example.":::
...
:::image type="content" source="media/advanced-proactive-message-teams/image7.png" alt-text="Send to a security group option.":::
...
:::image type="content" source="media/advanced-proactive-message-teams/image8.png" alt-text="Settings under the more options menu.":::

2.  Turn on **Concurrency control** and set the degree of parallelism.

:::image type="content" source="media/advanced-proactive-message-teams/image9.png" alt-text="Slider control for setting the level or concurrency.":::
...
:::image type="content" source="media/advanced-proactive-message-teams/image10.png" alt-text="Expanded options panel in the connector.":::
...
:::image type="content" source="media/advanced-proactive-message-teams/image11.png" alt-text="The setting shows Notification via bot name.":::
