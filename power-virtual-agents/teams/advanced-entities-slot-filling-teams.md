...
1. In Power Virtual Agents, go to the **Entities** tab on the side navigation pane.
   ...
   ![Entities tab](media/entities-menu-teams.png)

   You'll see a list of the prebuilt entities available. 

   ![Entities pane](media/entities-1(draft)-teams.png)

1. Select the **Money** entity, which will open the details panel for the entity.

   ![Money entity description](media/entities-2(draft)-teams.png)
...
1. In Power Virtual Agents, go to the **Entities** tab on the side navigation pane.
   ...
   ![Go to Entities tab](media/entities-menu-teams.png)

2. Select **New custom entity** on the main menu.

   ![Select New custom entity](media/entities-new-teams.png)

3. This opens the entity creation window. Enter a name for the entity.

   ![Outdoor Store Categories entity](media/entities-3(draft)-teams.png)
...
![Smart match](media/entities-4(draft)-teams.png)
...
![Synonyms](media/entities-5(draft)-teams.png)
...
1. Under **Identify**, select the entity you created in [Custom entities](#custom-entities).
   ...
   ![Question node with entity selection](media/entities-6(draft)-teams.png)
...
1. You can also optionally select items to show as buttons. For example, if you’d like to show some categories as buttons for users to conveniently choose from as their input, you can simply choose **Select user options** and then pick them from the list that contains the items you added when you created the custom entity.
   ...
   ![Add condition nodes](media/entities-8(draft)-teams.png)
    
   ![More condition nodes](media/entities-9(draft)-teams.png)
...
![tracking between topics](media/entities-10(draft)-teams.png)
...
![Additional tracking between topics](media/entities-11(draft)-teams.png)
...
![Variable watch window](media/entities-12(draft)-teams.png)
...
![Variable watch window](media/entities-13(draft)-teams.png)
...
![tracking between topics for product and price categories](media/entities-14(draft)-teams.png)
...
![Skip question](media/entities-skip-node-teams.png)
