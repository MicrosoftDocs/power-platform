...
You can [add the bot directly into the team that the bot is created in](#add-bot-to-the-team-it-is-created-in) or [allow users to add the bot to any team that they are part of](#allow-users-to-add-bot-to-their-teams). Team members can also [remove the bot from the team](/powerapps/teams/remove-your-apps).
...
7. Select **Add** to add the bot to the team.
...
2. Open the bot you want to disallow users to add to any team.
...
When enabled your bot will automatically start a conversation with team members. To customize the bot's greeting message, [modify the Greeting system topic](teams/configure-bot-greeting-teams.md#change-the-bots-default-greeting).
...
2. Open the bot you want to modify.
...
6. Configure the private greeting options.
