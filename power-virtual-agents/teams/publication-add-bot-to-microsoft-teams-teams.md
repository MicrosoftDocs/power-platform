...
- [Setting the bot avatar icon](customize-default-canvas-teams.md) from the side pane under **Details** won't show up for bots that are approved by an admin. Bots approved by an admin will use the app icon as the bot avatar.
