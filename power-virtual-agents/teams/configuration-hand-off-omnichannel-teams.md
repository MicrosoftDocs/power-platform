...
1. Select **Settings**, and then **Transfer to agent**.
    ...
    ![IMAGE SHOWING SETTINGS PANEL OPENED](media/handoff-settings-teams.png)


1. Select the **Dynamics 365 Omnichannel for Customer Service** tile.

    ![IMAGE SHOWING OC TILE IN SETTINGS](media/handoff-oc-tile-teams.png)


1. To acknowledge the privacy policy, select **Next**. 
    >[!CAUTION]
    >Ensure that you adhere to [data sovereignty](data-location-teams.md) laws when you configure this integration as your bot will store and send user information to your Omnichannel for Customer Service instance.
...
[!INCLUDE [handoff-known-limitations](includes/handoff-known-limitations-teams.md)]
