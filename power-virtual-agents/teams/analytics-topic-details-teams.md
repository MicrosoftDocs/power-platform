...
:::image type="content" source="media/analytics-topics-details-teams.png" alt-text="From the Topic details page, select the Analytics tab." border="false":::

You can also hover over each topic in the Topics page and select the **Go to analytics** icon. 

:::image type="content" source="media/analytics-topics-teams.png" alt-text="Hovering shows the Go to analytics icon." border="false":::
