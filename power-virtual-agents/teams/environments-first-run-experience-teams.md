...
2. Go to the **Environments** tab and select **+ New** to open the **New environment** panel.
   ...
   ![Create environment](media/environments-create-1-teams.png)
...
- For **Region** select the [support data region](data-location-teams.md) where you want the environment to be created.
- Set **Create a database for this environment?** to **Yes**
- Select **Next**.
   
   ![Create environment](media/environments-create-2-teams.png)
...
To create a bot in an existing environment, select the environment in the [bot creation window](authoring-first-bot-teams.md).

![Select environment](media/select_environment_onboarding-teams.png)
...
> ![Environment expiration notification](media/ennvironemnt_expiration_notification-teams.png)

> [!NOTE]
> Note that there is a difference between an expiring environment and an expiring license. If your license is expiring, you will be able to extend it without losing any data. More information: [Sign up for a Power Virtual Agents trial](sign-up-individual-teams.md#trial-expiration).
...
Your environment might not show up in the drop-down menu due to one of the following:
 ...
 - The environment is created in an unsupported region. More information: [Supported data locations](data-location-teams.md).
