...
1. At the bottom of the side navigation pane, select **Settings** :::image type="content" source="media/settings-icon-teams.png" alt-text="Settings icon." border="false":::, and then select **System fallback**.
...
:::image type="content" source="media/system-fallback-topic-list-teams.png" alt-text="Fallback in the topic list." border="false":::
