...
1. At the bottom of the side navigation pane, select **Settings** :::image type="content" source="media/settings-icon-teams.png "Settings icon"" alt-text="Settings icon." border="false":::, and then select **System fallback**.

2. Select **"+Add"**.

  :::image type="content" source="media/settings-system-fallback-pane-teams.png "Open System fallback settings"" alt-text="Open System fallback settings.":::
...
:::image type="content" source="media/system-fallback-topic-list-teams.png "Fallback in the topic list"" alt-text="Fallback in the topic list." border="false":::
...
:::image type="content" source="media/system-fallback-default-content-teams.png "Fallback topic default content"" alt-text="Fallback topic default content." border="false":::
...
:::image type="content" source="media/delete-system-fallback-topic-teams.png "Delete the fallback topic"" alt-text="Delete the fallback topic.":::
