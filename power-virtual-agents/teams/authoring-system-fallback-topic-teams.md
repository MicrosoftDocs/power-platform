...
1. At the bottom of the side navigation pane, select **Settings** :::image type="content" source="media/authoring-system-fallback-topic-teams/settings-icon-teams.png" alt-text="Settings icon." border="false":::, and then select **System fallback**.

2. Select **"+Add"**.

  :::image type="content" source="media/authoring-system-fallback-topic-teams/settings-system-fallback-pane-teams.png" alt-text="Open System fallback settings.":::
...
:::image type="content" source="media/authoring-system-fallback-topic-teams/system-fallback-default-content-teams.png" alt-text="Fallback topic default content." border="false":::
...
:::image type="content" source="media/authoring-system-fallback-topic-teams/delete-system-fallback-topic-teams.png" alt-text="Delete the fallback topic.":::
