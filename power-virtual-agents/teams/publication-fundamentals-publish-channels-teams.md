...
Publication should take less than a few minutes and, when successful, you can [make the bot available to end users in Microsoft Teams](publication-add-bot-to-microsoft-teams-teams.md). You can do it later by closing the panel and selecting **Make bot available to others**.
