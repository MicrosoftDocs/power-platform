...
2. Select **Publish** to make the latest bot content available to your customers.
    ...
    :::image type="content" source="media/publication-fundamentals-publish-channels-teams/channel-publish-latest-content-teams.png" alt-text="Publish latest bot content.":::
