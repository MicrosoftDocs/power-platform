...
> [!TIP]
> You do not need to follow this document to add your Power Virtual Agents bot to your [website, Facebook, or Microsoft Teams](publication-fundamentals-publish-channels-teams.md).
>If your goal is to connect to a custom web-based or native app, your developers can learn more at [Add bot to mobile and custom apps](publication-connect-bot-to-custom-application-teams.md).
...
You should also read [Connect your bot to mobile and custom apps](publication-connect-bot-to-custom-application-teams.md) before following the instructions in this topic.
...
![Relay bot diagram](media/channel-relay-bot-diagram-teams.png)
...
1. Copy your bot's name in Power Virtual Agents.
   ...
   ![Get bot name](media/channel-get-bot-name-teams.png)
...
2. Select the channel you want to connect to. This topic uses Slack as an example.
   ...
   ![Slack channel](media/channel-slack-teams.png)
...
3. Copy and save the *Bot ID* and *Tenant ID* value by selecting **Copy**. You will need these when connecting your bot to the Azure Bot Service channel.
   ...
   ![Get bot parameters](media/channel-get-bot-parameters-slack-teams.png)
...
1. On every new external Azure Bot Service channel conversation start, start a Power Virtual Agents conversation. Refer to [Get Direct Line token](publication-connect-bot-to-custom-application-teams.md#get-direct-line-token) and [Use Direct Line to communicate with the bot](publication-connect-bot-to-custom-application-teams.md#use-direct-line-to-communicate-with-the-bot) for instructions on starting a new conversation with the bot.
...
5. Refer to [Use Direct Line to communicate with the bot](publication-connect-bot-to-custom-application-teams.md#use-direct-line-to-communicate-with-the-bot) for how to get the Power Virtual Agents bot's response. When the Power Virtual Agents bot's response is received, refer to [Parse conversation payload from the bot](publication-connect-bot-to-custom-application-teams.md#parse-conversation-payload-from-the-bot) for how to parse the response to the external Azure Bot Service channel response.
