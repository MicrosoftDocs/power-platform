...
3.	Go to the **Network** tab.
    ...
    >![DevTools in Microsoft Edge browser showing the Network tab](media/devtools-network-preview-teams.png)
...
1.  [Publish your bot to a demo website](https://docs.microsoft.com/power-virtual-agents/publication-connect-bot-to-web-channels).    
    >[!div class="mx-imgBorder"]
    ![Deploy our bot](media/open-deploy-teams.png)
...
3.  Open the Bot Emulator where you add the name and endpoint to your bot.
    >[!div class="mx-imgBorder"]
    ![Dialog to create new bot in the bot emulator](media/dispatch-bot-emulator-teams.png)
