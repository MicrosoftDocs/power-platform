...
1. Select **Settings**, and then select **General settings**.
    ...
    :::image type="content" source="media/export-settings.png "Screenshot showing the settings cog highlighted"" alt-text="Screenshot showing the settings cog highlighted." border="false":::

2. Under **Export/import bot**, select **Go to Power Apps Solutions**.
 
    :::image type="content" source="media/export-settings-powerapps.png "Link to the Power Platform admin center from Power Virtual Agents"" alt-text="Link to the Power Platform admin center from Power Virtual Agents." border="false":::
...
3. Sign in to Power Apps, go to the **Solutions** tab, and select **New solution**. Enter the information for each of the fields as described in this table, then select **Create**.
    ...
    :::image type="content" source="media/export-new-solution.png "New solution button highlighted"" alt-text="New solution button highlighted." border="false":::
...
1. Select **Add existing** and choose **Chatbot**.
    ...
    :::image type="content" source="media/export-add-chatbot.png "Add existing menu highlighted"" alt-text="Add existing menu highlighted." border="false":::

2. On the **Add existing chatbots** panel, select the bot (or bots) you want to export. Select **Add**.

    :::image type="content" source="media/export-add-chatbot-solution.png "Chatbot selected in the list of bots"" alt-text="Chatbot selected in the list of bots." border="false":::
...
1. In the list of solutions, select the solution that contains the bot you want to export. Select **Export**. 
    ...
    :::image type="content" source="media/export-solution.png "Export button"" alt-text="Export button." border="false":::
    ...
    >
    > :::image type="content" source="media/export-switch-classic.png "Switch to classic view"" alt-text="Switch to classic view." border="false":::
...
1. On the top menu, select the environment name and select the environment where you want to import your bot.
    ...
    :::image type="content" source="media/export-power-apps-environment.png "Environment picker selected"" alt-text="Environment picker selected." border="false":::

2. Go to the **Solutions** tab, and on the command bar, select **Import**.
 
    :::image type="content" source="media/export-import.png "Import button highlighted"" alt-text="Import button highlighted." border="false":::
...
:::image type="content" source="media/export-add-required-components.png "Screenshot highlighting the Add required components option under the More menu"" alt-text="Screenshot highlighting the Add required components option under the More menu." border="false":::
...
1. Select **See solution layers** from the contextual **...** menu next to the component name.
   ...
   :::image type="content" source="media/export-solution-layers.png "See solution layers option"" alt-text="See solution layers option." border="false":::
