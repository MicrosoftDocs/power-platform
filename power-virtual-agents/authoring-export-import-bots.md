...
- A maker will require two security roles to use this feature: Environment Maker and System Customizer. Learn more about [configuring user security to resources in an environment](https://docs.microsoft.com/power-platform/admin/database-security).
